...
![תרשים זרימה של לולאת for ב-PowerShell שבו המשתנה i עולה מ-1 עד שהתנאי i -le 5 נכשל](../../../images/illustrations/win-2-2-for-loop.svg)
...
![תרשים זרימה של תנאי if else ב-PowerShell שבו הערך 10 נבדק מול התנאי number -gt 5 ובוחר את הענף המתאים](../../../images/illustrations/win-2-2-if-else.svg)
