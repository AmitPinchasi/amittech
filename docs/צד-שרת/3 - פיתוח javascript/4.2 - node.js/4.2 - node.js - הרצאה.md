...
3. כשהפעולה מסתיימת – Callback/Promise נכנס לqueue
...
![איור המדגים את המודל הלא-חוסם של Node: ה-Thread הראשי שולח פעולה אסינכרונית וממשיך לעבוד בזמן שהיא רצה ברקע, וכשהיא מסתיימת ה-Callback נכנס לתור וה-Event Loop מריץ אותו](../../../images/illustrations/srv-3-2-node-event-loop.svg)
