...
```
app/
  __init__.py        # Empty file, marks the directory as a "package"
  database.py        # Connection to SQLite and Session definition
  models.py          # SQLAlchemy models including linking tables
  controllers.py     # All the project's controllers
...
# Many-to-Many linking tables between trips and other entities
trip_hotels = Table(
    "trip_hotels",
    Base.metadata,
...
# Create a trip with links to the created entities (assume id=1 was received for each)
