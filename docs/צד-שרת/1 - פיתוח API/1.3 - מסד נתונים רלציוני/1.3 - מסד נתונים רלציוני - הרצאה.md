...
![קשר one to many בין הטבלאות: עמודת hotel_id בטבלת הטיולים היא מפתח זר שמצביע אל ה-primary key בטבלת המלונות](../../../images/illustrations/srv-1-3-foreign-key.svg)
...
#### הקדמה
מסד הנתונים MySQL הוא אחד ממסדי הנתונים הרלציוניים הנפוצים והפופולריים בעולם. הוא בשימוש במילוני אתרים וסטארטאפים בגלל שהוא חינמי, מהיר ונתמך על ידי רוב שפות התכנות. הוא מאפשר queries SQL מורכבות, קשרים בין טבלאות, תמיכה גדולה לביצועים, גיבויים והפרדה בין יוזרים והרשאות.
...
- ביצועים נהדרים וqueries מתקדמות
