...
![לולאת ReAct של סוכן AI: הסוכן חושב, מפעיל כלי, קורא את התוצאה ובודק אם המטרה הושגה, ואם לא הוא חוזר לחשיבה עד שהמטרה מושגת](../../../images/illustrations/srv-1-7-react-loop.svg)
