...
![דפוס Cache-Aside עם Redis: בקשה שלא נמצאת במטמון נשלפת ממסד הנתונים ונשמרת ב-Redis, ובקשה חוזרת מוחזרת ישירות מהזיכרון](../../../images/illustrations/srv-1-5-cache-aside.svg)
