...
הMessage Queue היא **queue הודעות**.
...
הMessage Queue =  היא מערכת שמאפשרת לשלוח הודעות, לשמור אותן בqueue, ולצרוך אותן מאוחר יותר.
...
![עבודה אסינכרונית עם תור הודעות: ה-Producer פולט event אל ה-Broker וממשיך מיד, וה-Consumer צורך את ההודעה מאוחר יותר ומטפל בה](../../../images/illustrations/srv-1-6-message-queue.svg)
...
באמצעות queue הודעות, אנחנו יכולים לנתק לחלוטין שירותים בbackend שלנו, 
...
מערכת Kafka היא queue הודעות מאוד מבוזר.
...
- אני רוצה **לקרוא שוב events ישנים**?
- כמה מערכות שונות רוצות לקרוא את אותם events?
- יש לי **מאות אלפי events בשנייה**?
...
![דיאגרמה: ה-API מחובר ל-Kafka, למסד הנתונים mongoDB, ול-redis; Kafka שולח הודעות ל-mailing service, ו-redis מחובר גם הוא בחזרה אל ה-API](../../../images/Pasted image 20260127182012.png)
