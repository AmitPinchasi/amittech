...
variables.tf   ← variables (Region, instance type, ...)  
...
![איור מחזור העבודה של Terraform מהגדרת המשאבים בקוד דרך init, plan ו-apply ועד הקמת התשתית בענן ומחיקתה ב-destroy](../../../images/illustrations/srv-2-3-terraform-workflow.svg)
