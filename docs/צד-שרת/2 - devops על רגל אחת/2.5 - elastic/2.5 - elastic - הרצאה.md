...
1. **Logs – לוגים**
   ...
   * רשומות של events שקורים במערכת
...
* הinterface ויזואלי להצגת לוגים, מדדים וטרייסים
...
![איור צינור הנתונים של Elastic Stack מהלוגים בשרת דרך Filebeat, Logstash ו-Elasticsearch ועד הדשבורדים ב-Kibana](../../../images/illustrations/srv-2-5-elk-pipeline.svg)
