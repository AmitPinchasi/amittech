...
![איור המשווה בין Continuous Delivery ל-Continuous Deployment ומראה את שער ההפצה שבו הקוד נפרס אוטומטית או ממתין לאישור ידני](../../../images/illustrations/srv-2-4-delivery-vs-deployment.svg)
