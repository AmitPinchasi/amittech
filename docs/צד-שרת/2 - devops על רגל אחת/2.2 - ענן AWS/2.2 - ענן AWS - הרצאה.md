...
- שירותים כמעט לכל צורך:
    ...
    - הqueues ואירועים: SQS, SNS, EventBridge
...
![איור המדגים כיצד Load Balancer מפזר בקשות נכנסות בתורנות בין שלושה instances זהים של EC2 בסקיילינג אופקי](../../../images/illustrations/srv-2-2-load-balancer.svg)
...
![איור זרימה המראה כיצד Auto Scaling ב-AWS מוסיף instance כאשר עומס ה-CPU עולה מעל הסף, ואינו משנה דבר כשהעומס נמוך](../../../images/illustrations/srv-2-2-auto-scaling.svg)
...
- **EventBridge** – חיבור events בין שירותים
