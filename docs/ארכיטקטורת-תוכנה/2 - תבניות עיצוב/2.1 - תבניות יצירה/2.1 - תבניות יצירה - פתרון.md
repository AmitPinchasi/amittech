...
def create_exporter(format: str) -> ReportExporter:
    ...
    if exporter_class is None:
        raise ValueError(f"Unsupported format: {format}. Available formats: {list(exporters.keys())}")
...
tasks = [
    ...
    {"title": "Write tests", "status": "todo", "priority": "normal"}
]
...
logger2.warning("Failed attempt")
