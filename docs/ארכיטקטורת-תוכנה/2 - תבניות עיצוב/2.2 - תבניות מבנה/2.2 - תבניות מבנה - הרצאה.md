...
![תבנית Adapter: המתאם מקבל קריאה בממשק החדש ומתרגם אותה לקריאה בספרייה הישנה](../../../images/illustrations/arch-2-2-adapter-translate.svg)
...
![תבנית Facade: הקוד הקורא מפעיל פונקציה אחת פשוטה שמאחוריה ארבע תתי-מערכות](../../../images/illustrations/arch-2-2-facade-subsystems.svg)
