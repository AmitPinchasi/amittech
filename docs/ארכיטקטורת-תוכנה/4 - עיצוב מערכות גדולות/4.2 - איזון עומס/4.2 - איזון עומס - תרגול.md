...
class SmartLoadBalancer:
    ...
    def set_algorithm(self, algorithm: str):
        # supports: "round_robin", "least_connections", "random"
        ...
...
print(lb.get_server())  # expected: s3 (0 connections)
```
...
server_health = {
    "s1": True,
    "s2": True,
    "s3": False  # this server "went down"
}

# The LB needs to detect that server s3 is unhealthy and not send it requests
```
