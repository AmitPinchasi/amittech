...
הצייד אחרי Cache Poisoning הוא בעצם צייד אחרי פערים - למצוא כותרת, פרמטר, או ערך כלשהו שהשרת מתייחס אליו בעת בניית התגובה, אבל שהמטמון בפניו הוא בלתי נראה. זה דורש להבין את שרשרת השירותים המלאה - מה ה-CDN עושה, מה שרת הפרוקסי עושה, ומה האפליקציה בפועל עושה עם כל שדה בבקשה. זה בדיוק סוג העבודה שאנחנו מלמדים לעומק ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כי בלי להבין את שכבות התשתית שמסביב לאפליקציה, קשה מאוד לזהות חולשות כאלה.
