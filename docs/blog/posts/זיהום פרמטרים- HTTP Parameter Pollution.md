...
זיהום פרמטרים הוא דוגמה מצוינת לכך שהחולשות המעניינות ביותר לא תמיד נמצאות בקוד עצמו, אלא בפער בין איך ששכבות שונות של המערכת מפרשות את אותה בקשה בדיוק. זה סוג החשיבה השיטתית שאנחנו מפתחים ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/).
