...
מבחינת תקיפה ומחקר חולשות, הדרך למצוא Prototype Pollution היא לחפש בדיוק את הפונקציות האלה - מיזוג, קלון, פענוח קלט לתוך אובייקט קיים - ולנסות להזריק את המפתחות המיוחדים ולראות אם הם "דולפים" לאובייקטים אחרים. זה בדיוק סוג החולשה שאנחנו מתעכבים עליה לעומק ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כי היא דורשת הבנה של השפה עצמה ולא רק היכרות עם רשימת חתימות מוכרות.
