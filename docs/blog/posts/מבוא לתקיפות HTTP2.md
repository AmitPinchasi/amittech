...
ברמת המושג, הכלל החשוב ביותר הוא לא לסמוך על כך ש"פרוטוקול חדש" אומר "אין בעיות ישנות". כל שכבה חדשה שמתווספת - במיוחד שכבת תרגום בין גרסאות - היא הזדמנות חדשה לאותן משפחות בעיות להופיע שוב, רק בצורה קצת שונה. זו בדיוק סוג ההבנה שאנחנו בונים ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כשמדברים על תשתית ופרוטוקולים ולא רק על קוד אפליקציה.
