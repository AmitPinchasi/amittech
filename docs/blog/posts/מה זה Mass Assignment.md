...
זיהוי חולשות Mass Assignment דורש חשיבה קצת אחרת מסריקת קוד רגילה - צריך להשוות בין מה שממשק המשתמש מציג, לבין מה שה-API בפועל מוכן לקבל, ולבדוק בעצמכם אילו שדות "נשכחו" בלי הגבלה. זה בדיוק סוג הפער שאנחנו מתרגלים למצוא ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כי חולשות מהסוג הזה כמעט אף פעם לא בולטות לעין - צריך לדעת בדיוק איפה לחפש.
