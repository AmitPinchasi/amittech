...
זיהוי החולשה זה רק הצעד הראשון. אחרי שיש לכם אישור שהקלט שלכם מתפרש, יש עבודה אמיתית - לזהות איזה מנוע תבניות רץ מאחורי הקלעים, למצוא את המסלול המדויק מתוך התבנית לפונקציות מסוכנות בשפה, ולבנות פייאלוד שעובד בסביבה הספציפית הזו. זה בדיוק אחד הנושאים שאנחנו מפרקים לגורמים, שלב אחר שלב, ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כי בלי להבין את הפנימיות של המנוע קשה מאוד להתקדם מ"מצאתי חולשה" ל"הוכחתי השפעה אמיתית".
