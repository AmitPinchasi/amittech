...
רוב האנשים שמתחילים במחקר אתרים מכירים את XSS ו-SQL Injection, אבל הרבה פחות מכירים את XXE, למרות שהיא הופיעה לא מעט פעמים ברשימת OWASP Top 10 ויכולה להיות הרסנית לא פחות. הסיבה שהיא פחות מוכרת היא שהיא דורשת קצת יותר הבנה של איך פורמט XML עובד, אז בואו נתחיל משם.
...
בקורס [מחקר אתרים](https://amittech.dev/מחקר-אתרים/) אנחנו מכסים את XXE בפרק חולשות צד השרת, ומראים איך היא קשורה לחולשות אחרות כמו SSRF, כדי שתבינו את התמונה המלאה ולא רק חולשה בודדת מבודדת.
