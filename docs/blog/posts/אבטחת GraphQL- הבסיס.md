...
אם עברתם את הבסיס של מחקר אתרים מבוססי REST, יש לכם כבר אינטואיציה מסוימת - כל endpoint מחזיר סוג מוגדר מראש של מידע, ואתם בודקים אחד אחד אם יש בקרת הרשאה חסרה או קלט לא מסונן. הבעיה היא ש-GraphQL שובר את כל האינטואיציה הזאת מהיסוד, ואם אתם ניגשים אליו עם אותה חשיבה של REST, אתם מפספסים בדיוק את החולשות המסוכנות ביותר בו.
...
זה בדיוק אחד הנושאים שאנחנו מקדישים לו זמן אמיתי ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כדי שתדעו לבדוק API מבוסס GraphQL בצורה שמתאימה לו, ולא סתם להעתיק כלים ושיטות מעולם ה-REST.
