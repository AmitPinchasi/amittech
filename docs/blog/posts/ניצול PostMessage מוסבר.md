...
בדיקה מדוקדקת של תקשורת postMessage היא בדיוק סוג הפרט הקטן שמבדיל בין מבחן חדירה שטחי לבין כזה שבאמת מוצא את הבעיות המהותיות באפליקציה. זה נושא שאנחנו נכנסים אליו לעומק ב[קורס מחקר אתרים מתקדם](https://amittech.dev/מחקר-אתרים-מתקדם/), כי הרבה מהחולשות המעניינות ביותר באפליקציות עשירות בג'אווהסקריפט מסתתרות בדיוק בערוצי תקשורת כאלה שנראים תמימים.
