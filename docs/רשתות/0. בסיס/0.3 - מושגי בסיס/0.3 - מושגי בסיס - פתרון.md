...
![חישוב: המרת המספר הבינארי 101110 לדצימלי לפי חזקות של 2, התוצאה 46](../../../images/Pasted image 20250124184832.png)
2. **1111011**
    
![חישוב: המרת המספר הבינארי 1111011 לדצימלי לפי חזקות של 2, התוצאה 123](../../../images/Pasted image 20250124184839.png)
3. **10011010**
    
![חישוב: המרת המספר הבינארי 10011010 לדצימלי לפי חזקות של 2, התוצאה 154](../../../images/Pasted image 20250124184854.png)
4. **110010**
    
![חישוב: המרת המספר הבינארי 110010 לדצימלי לפי חזקות של 2, התוצאה 50](../../../images/Pasted image 20250124184901.png)
...
print(f"Binary: {binary_representation[2:]}")
print(f"Hexadecimal: {hex_representation[2:]}")
```
