...
כדי להבין מה בדיוק מזויף, כדאי להכיר את זרימת האימות התקינה בפרוטוקול Kerberos:

![זרימת האימות בפרוטוקול Kerberos: הלקוח מבקש אימות מה-KDC ומקבל TGT מוצפן, מציג את ה-TGT ומבקש כרטיס שירות, מקבל כרטיס שירות מה-KDC וניגש איתו לשירות המבוקש](../../../images/illustrations/pentest-5-7-kerberos-ticket-flow.svg)
