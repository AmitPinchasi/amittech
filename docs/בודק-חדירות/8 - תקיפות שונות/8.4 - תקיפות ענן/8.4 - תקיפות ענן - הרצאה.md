...
![מודל האחריות המשותפת בענן: ספק הענן אחראי על אבטחת החומרה, הרשת הפנימית והתשתית הפיזית, ואילו הלקוח אחראי על קונפיגורציית השירותים, ניהול ההרשאות, עדכוני התוכנה והצפנת הנתונים - ופערי תצורה אצל הלקוח הם מקור התקיפה הנפוץ ביותר בענן](../../../images/illustrations/pentest-8-4-shared-responsibility-model.svg)
...
3. הexploit הרשאות לקריאת נתונים רגישים
...
```
- יכולות חדשות לexploit Logic Apps
...
### **תרחיש 2: הexploit serverless לצורך התקפה**
```bash
