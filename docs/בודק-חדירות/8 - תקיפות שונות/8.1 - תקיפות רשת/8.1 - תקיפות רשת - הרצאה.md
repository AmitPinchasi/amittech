...
פרוטוקול ARP (Address Resolution Protocol) אחראי על התאמת כתובות IP לכתובות MAC ברשת מקומית. התקפה זו מתבצעת באמצעות שליחת תגובות ARP spoofed כך שהתוקף יכול להתחזות למחשבים אחרים.

![זרימת מתקפת ARP Poisoning: תקשורת תקינה בין הקורבן לשער, התוקף שולח תגובות ARP מזויפות לשני הצדדים, וכל התעבורה עוברת דרכו במתקפת Man-in-the-Middle](../../../images/illustrations/pentest-8-1-arp-poisoning-mitm.svg)
...
ב-DHCP Spoofing התוקף מפעיל שרת DHCP spoofed המספק למכשירים כתובות IP שגויות ומגדיר את עצמו כdefault gateway למחשבים אחרים.

![זרימת מתקפת DHCP Spoofing: הקורבן משדר בקשת DHCP לכל הרשת, שרת התוקף עונה לפני השרת הלגיטימי, והקורבן מקבל כתובת IP ו-Gateway מזויפים כך שכל תעבורתו עוברת דרך התוקף](../../../images/illustrations/pentest-8-1-dhcp-spoofing-race.svg)
...
ב-IP Spoofing התוקף שולח חבילות עם כתובת מקור spoofed, לרוב כדי לעקוף בקרות גישה או לשמש בהתקפות DDoS.
...
- שימוש בכתובת MAC spoofed כדי לעקוף בקרות רשת.
...
### 6. DNS Spoofing
- מתקפה שבה אנחנח עונים לבקשות DNS עם תשובות spoofed.
