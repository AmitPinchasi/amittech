...
### **שלב 1: הexploit באמצעות Procdump**
...
### **שלב 3: הdecoding עם secretsdump**

עוד כלי פופולרי לdecoding **LSASS** הוא **secretsdump** של `impacket`, המאפשר לגנוב **NTLM Hashes** מ- **LSASS** בצורה פשוטה ומהירה.
...
לאחר שגנבנו את ה- **NTLM Hashes**, ניתן להשתמש בהם לexploit **Pass-the-Hash**. זהו תהליך שבו נשתמש ב- **NTLM Hash** כדי להתחבר לחשבונות אחרים במערכת או ברשת, מבלי לדעת את הסיסמה המפורשת.
