...
![איור המדגים כיצד בזיהום פרמטרים ה-WAF בודק את הערך הראשון התקין בעוד PHP לוקח את הערך האחרון ומקבל את ההזרקה](../../../images/illustrations/webadv-8-3-hpp-first-last-split.svg)
