...
![איור המראה כיצד תווי Unicode ברוחב מלא חומקים מה-WAF ואז נורמליזציית NFKC באפליקציה ממירה אותם לתגית סקריפט מסוכנת](../../../images/illustrations/webadv-8-4-nfkc-mismatch.svg)
