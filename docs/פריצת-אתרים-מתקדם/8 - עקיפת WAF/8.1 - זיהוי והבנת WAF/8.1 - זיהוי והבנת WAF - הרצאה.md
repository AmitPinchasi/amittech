...
![תרשים הזרימה מראה כיצד בקשת HTTP מהלקוח עוברת דרך ה-WAF שבודק אותה בשכבה 7 ומחליט לחסום או להעביר לשרת האפליקציה](../../../images/illustrations/webadv-8-1-waf-request-path.svg)
...
![איור המדגים את צינור התאמת החוק ב-WAF שבו הקלט עובר פענוח URL והמרה לאותיות קטנות לפני שמורצת עליו התאמת ה-regex](../../../images/illustrations/webadv-8-1-rule-pipeline.svg)
