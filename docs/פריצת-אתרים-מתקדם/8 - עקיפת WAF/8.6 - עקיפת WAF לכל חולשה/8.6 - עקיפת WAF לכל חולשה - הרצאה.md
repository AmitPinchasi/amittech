...
![תרשים החלטה המראה כיצד תחביר SQL חלופי חומק מה-regex של ה-WAF בעוד מנוע ה-SQL מנרמל את התחביר ומריץ את ההזרקה](../../../images/illustrations/webadv-8-6-syntax-variant-bypass.svg)
