...
![איור המתאר הטעיית מטמון שבה הקורבן המחובר לוחץ על קישור עם סיומת css, השרת מתעלם מהסיומת ומחזיר דף הגדרות פרטי, המטמון שומר את התגובה לפי הסיומת, והתוקף קורא את המידע הפרטי מהמטמון](../../../images/illustrations/webadv-5-4-cache-deception-flow.svg)
