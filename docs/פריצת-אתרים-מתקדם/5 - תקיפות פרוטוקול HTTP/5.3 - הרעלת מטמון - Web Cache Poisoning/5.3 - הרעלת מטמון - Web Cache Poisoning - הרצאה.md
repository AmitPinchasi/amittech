...
![איור המתאר הרעלת מטמון דרך X-Forwarded-Host שבה השרת משקף את הheader בתגובה, המטמון שומר אותה תחת המפתח של en בלבד, וכל מבקר עוקב מקבל תוכן זדוני מהשרת של התוקף](../../../images/illustrations/webadv-5-3-cache-poison-flow.svg)
