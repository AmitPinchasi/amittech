...
![איור המתאר פיצול תגובות להרעלת מטמון שבו הזרקת CRLF מפצלת תגובה אחת לשתיים, ה-proxy משייך את התגובה המזויפת לבקשה ל-main.js, והמטמון שומר סקריפט זדוני שיוגש לכל מבקר](../../../images/illustrations/webadv-5-6-response-splitting.svg)
