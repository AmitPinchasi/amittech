...
![איור המתאר הרעלת תור תגובות שבה השרת החזיתי סופר שתי בקשות אך השרת האחורי מייצר שלוש תגובות, ולכן התור מוזז בעמדה אחת, הקורבן מקבל תגובה מוברחת והתוקף מקבל את תגובת הקורבן כולל ה-session](../../../images/illustrations/webadv-5-5-queue-desync.svg)
