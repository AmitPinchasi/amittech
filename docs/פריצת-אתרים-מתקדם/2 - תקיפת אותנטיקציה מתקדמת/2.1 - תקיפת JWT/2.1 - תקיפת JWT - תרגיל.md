...
5. הסירו את הsignature (השאירו נקודה בסוף)
...
האפליקציה משתמשת ב-RS256 לsignature טוקנים. המפתח הציבורי חשוף.
...
def solve():
    ...
    # Step 3: Create a token with algorithm confusion
    # ...
...
```python
# Complete the script for both attacks
import jwt
...
1. מה קורה אם השרת בודק את ה-URL גם ברמת ה-domain? אילו טכניקות bypass תנסו?
