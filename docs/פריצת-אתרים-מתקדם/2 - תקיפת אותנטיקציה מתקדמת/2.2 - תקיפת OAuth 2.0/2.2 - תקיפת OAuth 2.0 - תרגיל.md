...
4. אם נחסם - נסו את טכניקות הbypass הבאות:
...
```html
<!-- Complete the HTML that will be sent to the victim -->
<html>
<body>
    <!-- iframe/img that will trigger the callback -->
</body>
</html>
```
...
## תרגיל 4: הexploit Scope ו-Profile Information
...
class OAuthScanner:
    ...
    def check_pkce_required(self):
        """Check whether PKCE is required"""
        # ...
        pass

    def check_scope_validation(self):
        """Check whether scope is validated"""
        # ...
        pass
