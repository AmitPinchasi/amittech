...
![איור זרימת Authorization Code ב-OAuth המראה את השלבים מבחירת ההתחברות ועד החלפת הקוד בטוקן בבקשת צד-שרת](../../../images/illustrations/webadv-2-2-auth-code-flow.svg)
...
![איור המשווה בין בדיקת redirect_uri חלקית שמובילה לגניבת הקוד לבין התאמה מדויקת שחוסמת את התקיפה](../../../images/illustrations/webadv-2-2-redirect-uri-validation.svg)
