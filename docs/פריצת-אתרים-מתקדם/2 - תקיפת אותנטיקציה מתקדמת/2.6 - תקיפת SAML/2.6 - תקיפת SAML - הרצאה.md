...
![איור זרימת SP-Initiated SSO ב-SAML המראה את המסלול מהמשתמש דרך ה-IdP ועד אימות החתימה אצל ה-SP](../../../images/illustrations/webadv-2-6-saml-sso-flow.svg)
...
![איור המראה את תקיפת עטיפת החתימה ב-SAML שבה החתימה מאומתת על Assertion אחת אך ה-SP קורא את הזהות מ-Assertion זדונית](../../../images/illustrations/webadv-2-6-xsw-wrapping.svg)
