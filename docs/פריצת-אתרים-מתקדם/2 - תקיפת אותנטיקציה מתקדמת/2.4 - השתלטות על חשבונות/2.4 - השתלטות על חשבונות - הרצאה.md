...
![איור זרימה המראה כיצד הרעלת כותרת Host באיפוס סיסמה גורמת לקישור האיפוס להצביע לשרת התוקף ולדליפת הטוקן](../../../images/illustrations/webadv-2-4-reset-poisoning.svg)
