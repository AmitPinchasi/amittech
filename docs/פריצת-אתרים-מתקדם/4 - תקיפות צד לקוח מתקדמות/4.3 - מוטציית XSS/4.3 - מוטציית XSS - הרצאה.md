...
![תרשים המראה כיצד מוטציית XSS נוצרת מפרסור כפול: הסניטייזר מאשר, המחרוזת נכנסת ל-innerHTML ועוברת מוטציה, ומניעה בעזרת החזרת DOM fragment](../../../images/illustrations/webadv-4-3-mxss-double-parse.svg)
