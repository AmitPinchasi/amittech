...
class SafeRenderer {
  /**
   * Receives untrusted HTML and renders it safely
   * Requirements:
   * 1. Use DOMPurify with RETURN_DOM_FRAGMENT
   * 2. Second validation on the fragment before insertion
   * 3. Logging of mutation attempts
   */
