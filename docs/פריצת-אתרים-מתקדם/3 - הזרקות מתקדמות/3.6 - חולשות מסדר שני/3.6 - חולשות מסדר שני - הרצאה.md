...
![תרשים זרימה שמראה כיצד קלט זדוני נשמר בבטחה בשלב האחסון ומופעל מאוחר יותר בשאילתה לא בטוחה שמחליפה את סיסמת המנהל](../../../images/illustrations/webadv-3-6-second-order-flow.svg)
