...
2. הכינו DTD שמשתמש בשגיאות לextraction:
...
```bash
# Create a new DOCX or use an existing one
mkdir evil_docx && cd evil_docx
unzip ../template.docx

# Edit word/document.xml - add a DOCTYPE with XXE
# Repackage
