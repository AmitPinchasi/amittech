...
![תרשים שמראה כיצד קלט לא מסונן מוזרק לפילטר LDAP והופך את התנאי לאמת תמידית שעוקפת את האימות, וההגנה היא escaping ואימות דרך bind](../../../images/illustrations/webadv-3-4-ldap-filter-injection.svg)
