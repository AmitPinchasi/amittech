...
![תרשים החלטה שמראה כיצד אובייקט עם האופרטור ne עוקף אימות ומחזיר כל משתמש, בעוד קלט מסוג מחרוזת מחייב סיסמה נכונה, וההגנה היא אימות שהקלט הוא מחרוזת](../../../images/illustrations/webadv-3-2-nosql-auth-bypass.svg)
...
![אנימציה שמראה כיצד הזרקת NoSQL עיוורת עם regex מגלה תו נוסף של הסיסמה בכל סבב עד לחילוץ הסיסמה המלאה](../../../images/illustrations/webadv-3-2-nosql-blind-regex.svg)
