...
## תרגיל 2 - extraction נתונים עם $regex

PortSwigger Lab: **Exploiting NoSQL injection to extract data**

### משימות

1. מצאו נקודת injection באפליקציה
...
## תרגיל 3 - injection אופרטורים דרך Query Parameters
...
4. נסו מתקפת זמן (timing) לextraction עיוור
...
2. מצאו את כל נקודות הinjection
...
2. מנסה bypass אותנטיקציה עם אופרטורים שונים
