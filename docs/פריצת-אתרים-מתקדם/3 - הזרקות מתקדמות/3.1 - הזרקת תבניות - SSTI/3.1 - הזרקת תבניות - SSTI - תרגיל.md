...
1. מצאו את נקודת הinjection באפליקציה
...
- את נקודת הinjection שמצאתם
- את מנוע התבניות שזיהיתם
- את שרשרת הexploit שבניתם
- את ה-payload הסופי
...
```python
# Basic structure - complete the code
import requests
