...
![תרשים המראה כיצד שאילתת אינטרוספקציה אחת חושפת את כל סכמת ה-GraphQL ולכן יש לכבותה בפרודקשן](../../../images/illustrations/webadv-1-4-graphql-introspection.svg)
...
![עץ החלטה לעקיפת חסימת אינטרוספקציה במעבר מ-__type ל-GET ולבסוף לחשיפת שמות שדות משגיאות](../../../images/illustrations/webadv-1-4-introspection-bypass.svg)
...
2. **חקירת GraphQL** - אינטרוספקציה, bypass חסימות, שאילתות תקיפה
3. **חקירת SOAP** - ניתוח WSDL, זיהוי פעולות
4. **אותנטיקציה** - סוגי אותנטיקציה נפוצים ובדיקת bypass שלהם
5. **הbypass Rate Limiting** - טכניקות לbypass הגבלות קצב
