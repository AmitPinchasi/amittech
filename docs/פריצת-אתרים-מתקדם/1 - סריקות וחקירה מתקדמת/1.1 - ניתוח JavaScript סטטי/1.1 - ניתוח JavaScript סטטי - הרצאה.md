...
![תרשים זרימה של ניתוח JavaScript סטטי מאיתור הקבצים דרך בדיקת מפת המקור ועד להפיכת הממצאים למטרות לבדיקה](../../../images/illustrations/webadv-1-1-js-recon-flow.svg)
