...
## תרגיל 1 - bypass אימות עם magic hash (Apprentice)
...
## תרגיל 2 - bypass אימות עם JSON type manipulation
...
**רמז:** אם הטוקן מתחיל ב-`0e` או מכיל אותיות, יש אפשרויות שונות לbypass.

---

## תרגיל 5 - chaining בלבול טיפוסים עם SQLi
...
2. נסו injection SQL רגילה - האם `is_numeric` חוסמת אותה?
...
app.post('/api/auth', (req, res) => {
    ...
    // Vulnerable - the value is taken from the client request
