...
3. בדקו את התגובה - האם יש שדות שלא מוצגים בinterface?
...
**רמז:** חפשו הבדלים בגודל התגובה, בקוד הstatus, או בתוכן.
...
**רקע:**
הinterface REST API שמאפשר עדכון משאבים. המטרה: לשנות בעלות על משאב של משתמש אחר.
