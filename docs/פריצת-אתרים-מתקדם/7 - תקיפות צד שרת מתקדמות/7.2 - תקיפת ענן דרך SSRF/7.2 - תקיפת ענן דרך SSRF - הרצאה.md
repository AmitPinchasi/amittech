...
![איור המתאר כיצד מקור הבקשה עובר מהתוקף אל השרת הפגיע, שממנו הבקשה מגיעה לשירות המטא-דאטה הפנימי בכתובת 169.254.169.254 ומחזירה את הרשאות ה-IAM של השרת לידי התוקף](../../../images/illustrations/webadv-7-2-metadata-origin.svg)
...
![תרשים החלטה שמראה כיצד IMDSv2 חוסם SSRF: קבלת הרשאות דורשת קודם בקשת PUT עם כותרת מיוחדת לקבלת טוקן, ולכן בקשת SSRF שמוגבלת ל-GET נחסמת ומקבלת שגיאת 401](../../../images/illustrations/webadv-7-2-imdsv2-token.svg)
