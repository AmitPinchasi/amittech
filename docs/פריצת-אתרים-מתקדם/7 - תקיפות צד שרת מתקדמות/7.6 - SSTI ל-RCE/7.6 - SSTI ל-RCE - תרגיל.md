...
```jinja2
{# use request.args to bypass a filter #}
{{ request|attr(request.args.a)|attr(request.args.b) }}
{# with URL: /greet?name=PAYLOAD&a=__class__&b=__mro__ #}
...
class SSTIScanner:
    ...
    RCE_PAYLOADS = {
        'jinja2': [
            # TODO: add at least 5 different chains
        ],
        'twig': [
            # TODO: add at least 3 different chains
        ],
        'freemarker': [
            # TODO: add at least 2 different chains
        ],
    }
    ...
    def exploit(self, command):
        """Exploit based on the detected engine"""
        # TODO
        pass
