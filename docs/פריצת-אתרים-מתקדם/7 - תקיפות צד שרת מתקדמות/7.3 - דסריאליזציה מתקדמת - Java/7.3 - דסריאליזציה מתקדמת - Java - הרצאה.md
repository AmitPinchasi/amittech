...
![איור המתאר שרשרת Gadget ב-Java שבה פענוח אובייקט לא מהימן מפעיל רצף קריאות מתודה מ-readObject דרך hashCode ו-get ו-transform עד להרצת פקודה עם Runtime.exec](../../../images/illustrations/webadv-7-3-gadget-chain.svg)
