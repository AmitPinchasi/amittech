...
![איור המתאר את מתקפת DNS Rebinding שבה בשלב הבדיקה הדומיין נפתר לכתובת חיצונית ועובר את ההגנה, ובשלב השליחה עם TTL אפס הוא נפתר מחדש לכתובת פנימית והבקשה מגיעה ל-SSRF](../../../images/illustrations/webadv-7-1-dns-rebinding.svg)
