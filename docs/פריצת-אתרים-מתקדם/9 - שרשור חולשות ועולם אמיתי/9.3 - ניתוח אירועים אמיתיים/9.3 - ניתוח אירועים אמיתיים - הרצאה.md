...
![איור המדגים את שרשרת ההשתלטות ב-GitLab שבה דליפת token איפוס והגדרת CORS פרוצה מאפשרות לתוקף לקרוא את ה-token ולהשתלט על החשבון](../../../images/illustrations/webadv-9-3-gitlab-chain.svg)
...
![איור המדגים את שרשרת ה-exploit של Log4Shell וכיצד חסימת תקשורת יוצאת עוצרת את החיבור לשרת התוקף ומונעת את הרצת הקוד](../../../images/illustrations/webadv-9-3-log4shell-chain.svg)
