...
![איור זרימה המדגים כיצד Login CSRF מחבר את הקורבן לחשבון התוקף שבו מוזרק Self-XSS, וכך הקוד רץ בדפדפן הקורבן וגונב את הסשן שלו](../../../images/illustrations/webadv-9-2-selfxss-login-csrf.svg)
...
![איור המדגים כיצד כל חוליה שמתווספת לשרשרת מעלה את ציון ה-CVSS, מ-Self-XSS חסר ערך ועד השתלטות בחומרה קריטית](../../../images/illustrations/webadv-9-2-severity-ladder.svg)
