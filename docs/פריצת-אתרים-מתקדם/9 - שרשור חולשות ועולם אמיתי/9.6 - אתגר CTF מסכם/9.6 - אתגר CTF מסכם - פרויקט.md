...
| Redis | Redis 7 | 6379 | הcache וסשנים |
...
| בינוני | צריך: (1) JWT אדמין מהשלב 2, (2) Request Smuggling מהשלב 8 כדי לעקוף את בדיקת ה-IP, (3) הheader `X-Internal-Token` שנמצאת דרך ה-SSRF |
...
```
Stage | Topic                | Course section link | Difficulty
=====|======================|===================|======
1    | Recon                | Section 1         | Easy
2    | JWT                  | Section 2         | Medium
3    | OAuth                | Section 2         | Medium
4    | 2FA bypass           | Section 6         | Medium
5    | GraphQL              | Section 3         | Easy
6    | SSTI                 | Section 7         | Medium
7    | Prototype Pollution  | Section 4         | Hard
8    | Request Smuggling    | Section 5         | Hard
9    | Race Condition       | Section 6         | Medium
10   | SSRF + cloud         | Section 7         | Medium
11   | Deserialization      | Section 7         | Hard
12   | Chaining             | Section 9         | Very hard
```
