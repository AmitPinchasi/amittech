...
# TODO: Step 1 - subdomain enumeration
# TODO: Step 2 - availability check
# TODO: Step 3 - technology detection
# TODO: Step 4 - content discovery
# TODO: Step 5 - vulnerability scan
# TODO: summary report
```
...
requests:
  - method: GET
    ...
    matchers:
      # TODO: regex patterns to detect API keys
```
...
- עם encoding: `?redirect=https%3A%2F%2Fevil.com`
...
1. הdecoding של הטוקן והדפסת Header ו-Payload
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print(f"Usage: {sys.argv[0]} <token> <target_url>")
        sys.exit(1)
