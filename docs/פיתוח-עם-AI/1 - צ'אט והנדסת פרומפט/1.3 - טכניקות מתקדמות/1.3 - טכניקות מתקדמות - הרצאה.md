...
![המחשה של למידה מדוגמאות few-shot - המודל לומד את התבנית משתי הדוגמאות ומחיל אותה על כל שם משתנה חדש שמומר לcamelCase](../../../images/illustrations/ai-1-3-few-shot.svg)
...
![תרשים שרשור מחשבה - המודל עובר שלב אחר שלב על גבול התנאי ומגלה שההשוואה צריכה להיות גדול או שווה במקום גדול, במקום לקפוץ ישר למסקנה](../../../images/illustrations/ai-1-3-chain-of-thought.svg)
