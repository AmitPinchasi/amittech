...
![תרשים זרימת עבודה לכתיבת פיצ'ר עם agent: מטרה ואז תכנון שחושף שאלות פתוחות לענות עליהן, יישום בצעדים, וסקירת diff שאם מצאה בעיה חוזרת ליישום ורק אחריה מריצים בדיקות](../../../images/illustrations/ai-3-2-feature-workflow.svg)
