...
![תרשים לולאת דיבוג שיטתי: מזינים context מלא, משחזרים בבדיקה נכשלת, בונים השערה ובודקים אותה, ואם היא לא אומתה חוזרים להשערה חדשה, ורק אחרי אימות מטפלים בשורש הבעיה](../../../images/illustrations/ai-3-3-debug-loop.svg)
