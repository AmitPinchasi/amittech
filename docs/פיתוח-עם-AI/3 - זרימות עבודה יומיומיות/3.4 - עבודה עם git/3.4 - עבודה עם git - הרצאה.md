...
![תרשים זרימת עבודה עם git מול agent: פותחים branch ייעודי, עובדים, בוחרים אילו קבצים נכנסים לstaging, סוקרים diff ומחפשים secrets, ורק אחרי אישור מפורש עושים commit ודוחפים לPR](../../../images/illustrations/ai-3-4-git-workflow.svg)
