...
![תרשים זרימה של הזרקת context דינמי בskill: המשתמש מפעיל את הפקודה, המעטפת מריצה מראש את git diff, הפלט מחליף את ה-placeholder, ו-Claude מקבל את התוצאה ולא את הפקודה](../../../images/illustrations/ai-6-5-dynamic-context.svg)
