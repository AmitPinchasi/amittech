...
![תרשים של מתזמר שמאציל שתי חקירות במקביל לשני סוכני משנה, האחד על מודול auth והשני על מודול DB, כשכל אחד מחזיר סיכום שהמתזמר מסנתז](../../../images/illustrations/ai-6-3-parallel-delegation.svg)
