...
![איור המראה כיצד מעבד out-of-order ממלא את זמן ההמתנה ל-cache miss בהרצת הוראות עצמאיות, בעוד ההוראה התלויה ממתינה עד שהערך מגיע מהזכרון ואז מתבצעת](../../../images/illustrations/core-8-4-ooo-fill-stall.svg)
...
![איור המראה כיצד שינוי שמות אוגרים ממפה כל כתיבה ל-eax לאוגר פיזי חדש, וכך מבטל את התלות הכוזבת ומאפשר לשני זוגות ההוראות לרוץ במקביל](../../../images/illustrations/core-8-4-register-renaming.svg)
