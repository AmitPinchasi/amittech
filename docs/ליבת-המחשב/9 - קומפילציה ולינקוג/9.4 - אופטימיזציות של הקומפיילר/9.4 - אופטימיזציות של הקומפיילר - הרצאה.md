...
![אנימציה של הפצת קבועים, שמראה כיצד הקומפיילר עוקב אחרי הערך של כל משתנה בתורו, מחשב את x כ-5, את y כ-15 ואת z כ-20 כבר בזמן הקומפילציה, כך שבאסמבלי הסופי נשאר רק הקבוע ולא החישוב](../../../images/illustrations/core-9-4-constant-propagation.svg)
