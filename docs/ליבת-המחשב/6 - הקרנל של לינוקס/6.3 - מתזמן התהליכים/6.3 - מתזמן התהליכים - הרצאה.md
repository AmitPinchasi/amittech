...
![תרשים מעברי המצבים של תהליך בקרנל מהיצירה למצב מוכן, לריצה על המעבד, לשינה בהמתנה לאירוע, ולבסוף למצב זומבי ולשחרור](../../../images/illustrations/core-6-3-task-states.svg)
...
![תרשים המראה כיצד המתזמן בוחר בכל פעם את התהליך עם ה-vruntime הנמוך ביותר, וכיצד ה-vruntime של התהליך הרץ עולה ומעביר את התור לתהליך הבא](../../../images/illustrations/core-6-3-vruntime-pick.svg)
