...
![תרשים המראה כיצד כל שכבה במחסנית הרשת מזיזה את המצביע data אחורה עם skb_push וכותבת את ה-header שלה בשטח הפנוי בלי להעתיק נתונים](../../../images/illustrations/core-6-9-skb-push-headers.svg)
