...
![תרשים המראה כיצד הערך באוגר rax משמש כאינדקס לטבלת sys_call_table וכיצד מספרים שונים מובילים לפונקציות קרנל שונות](../../../images/illustrations/core-6-2-syscall-table-lookup.svg)
...
![תרשים המסע של קריאת מערכת מהכנת האוגרים ביוזר מוד, דרך הפקודה syscall ונקודת הכניסה entry_SYSCALL_64, ועד החזרה עם sysret](../../../images/illustrations/core-6-2-syscall-entry-path.svg)
