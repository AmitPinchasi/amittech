...
הדפוס כאן הוא: dlopen פותח את הso, dlsym מחפש symbol בתוכו, ואנחנו עושים cast ל-function pointer ומשתמשים. בפרויקט הסיכום (10.6) נרחיב את הרעיון הזה למערכת plugins שלמה.
