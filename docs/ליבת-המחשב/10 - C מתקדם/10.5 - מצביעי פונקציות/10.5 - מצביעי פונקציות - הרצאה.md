...
![איור המראה טבלת ניתוב של מצביעי פונקציות, שבה הערך של opcode משמש אינדקס ישיר לתא בטבלה והקריאה מגיעה לפונקציה המתאימה](../../../images/illustrations/core-10-5-dispatch-table.svg)
...
![איור המראה כיצד אותה קריאה לspeak מגיעה לפונקציה אחרת לכל מופע, לפי המצביע ששמור בתוך הstruct](../../../images/illustrations/core-10-5-struct-vtable.svg)
