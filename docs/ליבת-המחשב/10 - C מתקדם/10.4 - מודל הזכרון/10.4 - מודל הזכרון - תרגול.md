...
### תרגול 5 - הqueue lock-free

1. ממשו queue SPSC (single-producer single-consumer) פשוט עם מערך מעגלי:
...
2. צרו thread יצרן שדוחף מספרים 0-999 לqueue, ו-thread צרכן שקורא אותם ומדפיס.
3. ודאו שכל המספרים מגיעים בסדר הנכון וללא אבדן.
4. מה קורה אם הqueue מתמלא? איך הthread היצרן צריך להתנהג?
