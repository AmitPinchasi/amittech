...
![איור המראה כיצד סידור מחדש של הקומפיילר הופך את סדר הכתיבות, וthread אחר רואה את b מעודכן בזמן ש-a עדיין אפס](../../../images/illustrations/core-10-4-compiler-reorder.svg)
...
![איור המראה את הסינכרון בין יצרן לצרכן, שבו הכתיבה לנתונים מתבצעת לפני פרסום הדגל ולכן הצרכן מובטח לראות את הערך המעודכן](../../../images/illustrations/core-10-4-acquire-release.svg)
