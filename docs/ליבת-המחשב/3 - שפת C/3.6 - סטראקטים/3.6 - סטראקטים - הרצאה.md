...
Student s2 = s1; // copies all fields
...
d.f = 3.14; // now i is no longer valid
printf("%f\n", d.f);
```
...
![איור המשווה בין struct שבו כל שדה מקבל מקום נפרד בזיכרון לבין union שבו כל השדות יושבים על אותם בתים](../../../images/illustrations/core-3-6-struct-vs-union.svg)
...
![איור המראה את פריסת השדות של struct בזיכרון בית אחרי בית, כולל שלושת הבתים הריקים שהקומפיילר מוסיף כדי ליישר את השדה מסוג int](../../../images/illustrations/core-3-6-struct-padding.svg)
