...
.loop:
   ...
   jg     .end                  ; if i > 100 -> jump to end

   mov    -4(%rbp), %eax        ; eax = i
   mov    $7, %edx
   xor    %edx, %edx
   div    %edx                  ; eax / 7 -> rdx = remainder
   cmp    $0, %edx              ; check if remainder is 0
   jne    .skip                 ; if not divisible by 7, skip

   ; here a call to printf would happen with i as the parameter
