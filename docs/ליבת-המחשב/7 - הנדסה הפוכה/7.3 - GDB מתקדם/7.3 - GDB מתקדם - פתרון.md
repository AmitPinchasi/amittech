...
; ... scanf("%d", &num) ...
0x4011c0:  mov    edi, [rbp-4]        ; load num into edi
0x4011c3:  call   0x401149 <check_magic>
0x4011c8:  test   eax, eax            ; check the return value
0x4011ca:  je     0x4011d8            ; if 0 -> "Not a magic number"
...
```asm
0x40121a:  movzx   eax, byte [rbp-0x1e+...]   ; character from the input
0x40121e:  movzx   edx, byte [rbp-0x12+...]   ; character from the key
0x401222:  cmp     al, dl                      ; comparison
0x401224:  jne     0x401240                    ; if different -> return 0
```
