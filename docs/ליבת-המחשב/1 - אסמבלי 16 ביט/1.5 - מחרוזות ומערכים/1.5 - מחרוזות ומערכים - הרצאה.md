...
![אנימציה של מערך בזיכרון, שמראה כיצד כל איבר יושב בכתובת עוקבת וכיצד הכתובת של כל איבר מחושבת מכתובת הבסיס ומהאינדקס](../../../images/illustrations/core-1-5-array-memory.svg)
...
![אנימציה של לולאת העתקת מערך, שמראה כיצד בכל סיבוב מועתק איבר אחד מהמקור אל היעד, הרגיסטרים si ו-di מתקדמים בשניים והרגיסטר cx יורד באחד](../../../images/illustrations/core-1-5-copy-loop.svg)
