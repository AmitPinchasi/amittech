...
![ASCII art: ציור של דג, בנוי כולו מתווי טקסט כמו סוגריים, קווים נטויים וסימני גרש](../../../images/Fish-shell-logo-ascii-black.svg.png)
...
MouseHandler proc
    pusha
    ; here the data is structured as:
    ; BX=buttons, CX=X, DX=Y, SI=wheel/0, DI=deltaX? depends on version
    popa
    iret
MouseHandler endp
```