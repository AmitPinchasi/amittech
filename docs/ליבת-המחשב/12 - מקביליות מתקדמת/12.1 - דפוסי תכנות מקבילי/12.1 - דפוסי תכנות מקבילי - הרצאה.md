...
![תרשים זרימה מונפש של המתנה על משתנה תנאי בתוך לולאת while, שבו אחרי כל התעוררות בודקים את התנאי מחדש לפני שממשיכים](../../../images/illustrations/core-12-1-cond-wait-while.svg)
...
![איור מונפש של תור מוגבל בין יצרן לצרכן, שבו המונה עולה עד שהתור מתמלא, היצרן נרדם, והצרכן מוציא פריט ומעיר אותו](../../../images/illustrations/core-12-1-producer-consumer-queue.svg)
...
![איור מונפש של בריכת תהליכונים, שבו ארבעה עובדים קבועים מושכים משימות מתור משותף וחוזרים לישון כשהתור מתרוקן](../../../images/illustrations/core-12-1-thread-pool.svg)
