...
![איור מסירת סיגנל לתהליך: הקרנל עוצר את הלולאה הראשית כשמגיע SIGINT, מריץ את הhandler שמשנה את הדגל running מ-1 ל-0, מחזיר את השליטה לקוד שהופסק, והתנאי שנכשל מוביל ליציאה נקייה](../../../images/illustrations/core-5-4-signal-delivery.svg)
