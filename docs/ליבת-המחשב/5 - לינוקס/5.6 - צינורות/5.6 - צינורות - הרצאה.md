...
![איור מימוש האופרטור צינור בshell: התהליך ls מפנה את המתאר 1 לצד הכתיבה וכותב את שמות הקבצים, הנתונים עוברים דרך הבאפר בקרנל, והתהליך grep קורא אותם מצד הקריאה ומדפיס רק את השורות המתאימות](../../../images/illustrations/core-5-6-shell-pipe-operator.svg)
