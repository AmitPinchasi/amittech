...
![דיאגרמה: ארבעה processes (Process 1, 2, 3, 4) ממחישים מבנה עץ של תהליכים במערכת ההפעלה](../../../images/Pasted image 20260214135153.png)
...
![איור הקריאה fork שחוזרת פעמיים: הקרנל מייצר תהליך בן, האב מקבל את מזהה הבן והבן מקבל אפס, ולכן אותו תנאי if מוביל את כל אחד מהם למסלול קוד אחר](../../../images/illustrations/core-5-2-fork-returns-twice.svg)
...
![איור מסלול קוד היציאה מהתהליך הבן אל התהליך האב: הבן מסתיים עם קוד 0, הקרנל מסמן אותו כזומבי ושומר את הקוד, והקריאה wait מעבירה את הערך למשתנה status ומשחררת את הבן](../../../images/illustrations/core-5-2-wait-exit-code.svg)
