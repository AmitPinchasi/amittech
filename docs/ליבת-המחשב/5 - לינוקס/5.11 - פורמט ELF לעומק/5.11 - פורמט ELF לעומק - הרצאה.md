...
![איור הקשר בין סקשנים לסגמנטים בקובץ ELF: כל סקשן נכנס לסגמנט טעינה עם ההרשאות שלו, סקשן text עם קריאה והרצה, data ו-bss עם קריאה וכתיבה, וסקשן symtab כלל לא נטען לזכרון](../../../images/illustrations/core-5-11-sections-to-segments.svg)
