...
![איור מרוץ תחרות בין שני תהליכונים: הפעולה counter++ מתחלקת לשלושה שלבים, שני התהליכונים קוראים את הערך 5 לפני שאחד מהם כתב, שניהם מחשבים 6 וכותבים 6, ולכן עדכון אחד אובד והמונה מגיע ל-6 במקום ל-7](../../../images/illustrations/core-5-8-race-condition.svg)
