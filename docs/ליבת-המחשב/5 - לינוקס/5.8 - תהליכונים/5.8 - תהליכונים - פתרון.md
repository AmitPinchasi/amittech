...
int main() {
    ...
    // the result will not be 2000000 in most runs!
    return 0;
}
```
...
int main() {
    ...
    printf("final counter = %d\n", counter);
    // now the result is always 2000000
...
void *compute_length(void *arg) {
    ...
    // return the length as void* using a cast
...
int main() {
    // initialize the array - all elements are 1
    ...
    // create 4 threads, each handling a quarter of the array
