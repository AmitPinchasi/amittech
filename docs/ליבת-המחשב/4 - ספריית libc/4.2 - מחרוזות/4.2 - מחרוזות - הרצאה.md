...
![איור המראה כיצד הפונקציה strcat מוצאת את תו הסיום של המחרוזת הראשונה, מעתיקה לשם את המחרוזת השנייה, וכותבת תו סיום חדש בסוף](../../../images/illustrations/core-4-2-strcat-append.svg)
...
![איור המראה כיצד הפונקציה strchr בודקת תו אחרי תו במחרוזת עד שהיא מוצאת את התו המבוקש ומחזירה מצביע למקום שלו](../../../images/illustrations/core-4-2-strchr-search.svg)
