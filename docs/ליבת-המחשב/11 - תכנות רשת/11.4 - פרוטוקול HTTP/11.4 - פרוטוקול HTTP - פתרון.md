...
void handle_request(int client_fd)
{
    ...
    if (strcmp(method, "POST") == 0 && strcmp(path, "/submit") == 0) {
        ...
        /* normal handling of static files */
...
/* read headers and return a pointer to the body */
             ...
             int redirect_count)
{
    ...
    if (status_code == 301 || status_code == 302) {
        ...
        /* parse the location - if it starts with http://, extract hostname and path */
    ...
    /* write what's already been read (after the headers) */
