...
3. הprocess האב מדפיס את ה-PID של כל ילד שנוצר.
4. טפלו ב-SIGCHLD כדי למנוע processes zombie.
...
```c
/* for each connection, create a thread that connects to the server and sends messages */
