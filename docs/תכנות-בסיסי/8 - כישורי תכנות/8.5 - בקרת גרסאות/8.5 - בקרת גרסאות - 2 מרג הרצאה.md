<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/0NYP5CF1u8Y" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
```
![דיאגרמת עץ גיט: לאחר git commit --amend, שם הקומיט שינה מ-some changes.. ל-reformatted main.py, ו-main ו-HEAD מצביעים עליו](../../../images/Pasted image 20240210143621.png)
...
git revert main
```
![דיאגרמת עץ גיט: git revert יצר קומיט חדש reverted last commit שמבטל את השינויים של reformatted main.py](../../../images/Pasted image 20240210144120.png)
...
```
![דיאגרמת עץ גיט: git merge יצר בענף dev קומיט חדש dev merged with main! שממזג את added main function עם reverted last commit](../../../images/Pasted image 20240210145013.png)
...
```
![דיאגרמת עץ גיט: git pull ממזג את added docstring to functions מ-dev לתוך main, יוצר קומיט pulled dev to main](../../../images/Pasted image 20240210150523.png)
...
- תראו את הדוגמה הבאה:
![דיאגרמה: שני ענפים ששינו את אותו קובץ main.py באופן שונה מקומיט משותף added main.py, ולכן לא ניתן למזג אותם אוטומטית (can't merge main.py)](../../../images/Pasted image 20240211202205.png)
```bash
# Adding main.py
git add main.py
...
![תרשים זרימה של פתרון קונפליקט בגיט: אם המיזוג נתקל בקונפליקט עורכים את הקבצים המסומנים, ממשיכים עם git merge --continue ולבסוף עושים קומיט](../../../images/illustrations/8-5-conflict-resolution.svg)
...
git rebase main
```
![דיאגרמת עץ גיט: לפני ואחרי git rebase - קומיטים A ו-B מהענף המסתעף מוצבים מחדש ברצף ישר אחרי init project](../../../images/Pasted image 20240212222108.png)
