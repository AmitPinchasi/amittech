...
![תרשים המראה כיצד לקוח FTP שולח פקודות כמו LIST, GET ו-PUT לשרת, והשרת מגיב בהתאם עם רשימת הקבצים, הורדה או העלאה](../../../images/illustrations/8-2-ftp-client-server.svg)
