...
![תרשים זרימה של יוניט טסט שקורא למתודה, שומר את הערך שחזר ומשווה אותו לערך הצפוי, ואם הם שווים הטסט עובר ואחרת נכשל](../../../images/illustrations/8-3-unit-test-flow.svg)
...
![תרשים המראה כיצד כל שלשה ברשימת parametrize מריצה את אותו טסט פעם נוספת עם ערכים אחרים, כך ששלוש שלשות הופכות לשלושה טסטים נפרדים](../../../images/illustrations/8-3-parametrize-cases.svg)
