...
![תרשים המשווה בין קלט תמים שמחזיר את המשתמש הנכון בלבד לבין קלט זדוני שהופך את התנאי לאמת תמידית ופותח גישה ללא סיסמה נכונה](../../../images/illustrations/8-7-sql-injection.svg)
- מסקנות:
