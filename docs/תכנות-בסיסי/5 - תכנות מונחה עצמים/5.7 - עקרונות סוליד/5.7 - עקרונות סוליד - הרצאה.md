<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/UVfBYMyLeus" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
- **שימוש באבסטרקציה:**
    - כדי להשיג את עקרון הפתוח-סגור, לעתים קרובות משתמשים באבסטרקציה. זה כולל הגדרת מחלקות אבסטרקציות או interfaces.
...
## עקרון: Interface segregation principle - הפרדת interface
- מחלקות לא צריכות ליישם interfaces שהן לא צריכות.

- **הימנעות מיישומים כפויים:**
    - על ידי יצירת interfaces ספציפיים, מחלקות אינן נאלצות ליישם מתודות שאינן רלוונטיות לפונקציונליות שלהן. זה עוזר בהפחתת תלות מיותרת ובעיות פוטנציאליות הקשורות ליישום שיטות שאין להן משמעות בהקשר של מחלקה מסוימת.
- **מניעת interfaces גדולים:**
    - הinterfaces גדולים, המכילים מתודות רבות, עלולים להיות בעייתיים. מחלקות שמיישמים interfaces כאלה עלולים להיות כבדים באחריות מיותרת. העקרון ממליץ לפרק interfaces כאלה לinterfaces קטנים יותר וממוקדים יותר כדי למנוע בעיה זו.
...
![תרשים שמראה את עקרון היפוך התלות: מחלקת Switch תלויה רק באבסטרקציה Switchable, שאותה מממשת מחלקת LightBulb](../../../images/illustrations/5-7-dip-abstraction.svg)
