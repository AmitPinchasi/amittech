<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/vxJTl3w8XP4" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>

## הורשה - Inheritance
- הורשה זה קונספט בסיסי בOOP שמאפשר למחלקה **לרשת** properties ממחלקה אחרת.
דוגמה:
```python
class Animal:
...
![אנימציה שמראה איך פייתון מחפש ממבר קודם במחלקת הבת Dog, ואם הוא לא נמצא שם עולה למחלקת האב Animal ומקבל אותו בירושה](../../../images/illustrations/5-5-inheritance-lookup.svg)
...
![אנימציה שמראה איך מתודת האתחול של מחלקת הבת קוראת דרך super לאתחול של מחלקת האב, וכך האובייקט החדש מקבל את השדות משתי המחלקות](../../../images/illustrations/5-5-super-init.svg)
...
- הinterface הוא מחלקה אבסטרקטית **שכל** הממברים שלה הם אבסטרקטים.
- מתי נשתמש בinterfaces? כאשר נרצה לחייב מחלקות לענות על רשימת חוקים, הinterface הוא רשימת מתודות שהמחלקה חייבת ליישם.

## הבדלים בין מחלקה אבסטרקטית לinterface
- מחלקה אבסטרקטית יכולה שיהיה לה מתודות רגילות ומתודות אבסטרקטיות.
- כל הממברים של interface חייבים להיות אבסטרקטים.