...
![אנימציה שמראה איך השמה לפרופרטי מפעילה את מתודת ה-setter, שבודקת את הערך החדש ורק אם הוא חוקי שומרת אותו בשדה הפרטי](../../../images/illustrations/5-4-property-setter.svg)
