...
![דיאגרמת מחלקות UML: מחלקת Entity (attack_power, defense, health, name, attack()) היא מחלקת אב של Character ו-Enemy; קיימות גם מחלקות Item ו-Location עצמאיות](../../../images/Pasted image 20240315175852.png)
