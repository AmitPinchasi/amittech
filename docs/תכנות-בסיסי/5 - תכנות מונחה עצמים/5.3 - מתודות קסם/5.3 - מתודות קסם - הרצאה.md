...
![אנימציה שמראה איך אופרטור החיבור מפעיל מאחורי הקלעים את מתודת הקסם add, שיוצרת אובייקט Point חדש עם סכום הערכים](../../../images/illustrations/5-3-add-magic-flow.svg)
