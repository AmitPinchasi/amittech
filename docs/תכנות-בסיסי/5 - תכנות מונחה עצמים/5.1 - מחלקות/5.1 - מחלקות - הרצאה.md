...
![אנימציה שמראה איך מתודת האתחול init רצה בעת יצירת אובייקט חדש ושומרת דרך self את הערכים בשדות האובייקט](../../../images/illustrations/5-1-init-self-flow.svg)
...
![אנימציה שמראה איך מחלקת Dog משמשת תבנית שממנה נוצרים שני אובייקטים, לכל אחד ערכים משלו](../../../images/illustrations/5-1-class-vs-objects.svg)
