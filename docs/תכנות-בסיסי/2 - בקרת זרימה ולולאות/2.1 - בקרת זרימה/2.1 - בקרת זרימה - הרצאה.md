...
![תרשים זרימה אנימטיבי של תנאי if else: הקוד בודק את התנאי age >= 18, אם התשובה כן מותר להיכנס ואם לא הכניסה נדחית, ובסוף התוכנית ממשיכה](../../../images/illustrations/2-1-if-else-flow.svg)
...
![תרשים זרימה אנימטיבי של שרשרת if elif else: התנאים נבדקים אחד אחרי השני לפי הסדר, וברגע שתנאי אחד מתקיים רץ רק הבלוק שלו](../../../images/illustrations/2-1-elif-chain.svg)
