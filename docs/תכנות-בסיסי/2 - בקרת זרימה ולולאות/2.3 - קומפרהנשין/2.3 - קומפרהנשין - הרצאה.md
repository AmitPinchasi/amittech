...
![אנימציה של ליסט קומפרהנשין עם תנאי: הלולאה עוברת על הערכים אחד אחד, כל ערך שעובר את התנאי נכנס לרשימה החדשה והערך שלא עובר מדולג](../../../images/illustrations/2-3-list-comp-filter.svg)
...
![אנימציה של הפונקציה zip: שתי רשימות מתחברות זוג זוג לפי האינדקס, וכל זוג הופך לטאפל אחד](../../../images/illustrations/2-3-zip-pairs.svg)
