<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/HKBCguQDAXE" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
![תרשים זרימה אנימטיבי של לולאת while: לפני כל סיבוב נבדק התנאי count < 5, כל עוד הוא נכון גוף הלולאה רץ וחוזרים לבדיקה, וכשהוא נכשל הלולאה נגמרת](../../../images/illustrations/2-2-while-loop.svg)
...
- לולאת `for` היא מבנה קוד בתכנות שמשמש לחזרה על סדרה של ערכים. ב-Python, לולאת `for` משמשת לרוב לעבור על אוסף של elements (כמו רשימה, מחרוזת, טווח מספרים וכו') ולבצע פעולה על כל אחד מהם.
...
- בדוגמה זו נוכל לראות רשימה בשם numbers ולולאת for אשר מבצעת את הפעולה:
   for number in numbers
  פעולה זו אומרת כך: עובר כל number (כלומר עבור כל element שיהיה, לא משנה אם זה רשימת מספרין או לא) ב- numbers, תדפיס את number. מה שזה בעצם עושה זה לעבור על element ברשימה numbers ומדפיס אותו. 

![אנימציה של לולאת for שעוברת על רשימה: בכל סיבוב המשתנה fruit מקבל את האיבר הבא ברשימה לפי הסדר, עד סוף הרשימה](../../../images/illustrations/2-2-for-list.svg)
...
- הפונקציה `items()` היא מתודה המשמשת על מילונים ב-Python. היא מחזירה רשימה של זוגות מפתח-ערך (key-value pairs) הנמצאים במילון. כל זוג מיוצג כ-tuple, כאשר האלמנט הראשון הוא הkey והשני הוא הערך.
```python
...
![תרשים זרימה אנימטיבי של break בלולאת while True: הלולאה חוזרת על עצמה עד שהתנאי מתקיים, ואז break יוצא ממנה מיד אל הקוד שאחריה](../../../images/illustrations/2-2-break-exit.svg)
...
![תרשים זרימה אנימטיבי של continue בלולאת for: כשהתנאי מתקיים מדלגים על ההדפסה וחוזרים ישר לתחילת הסיבוב הבא, ואחרת ממשיכים כרגיל](../../../images/illustrations/2-2-continue-skip.svg)
