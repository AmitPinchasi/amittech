...
![איור אנימציה המראה כיצד השורה x = x + 1 מחשבת את הערך הישן של x ועוד אחד ושומרת את התוצאה בחזרה במשתנה](../../../images/illustrations/1-2-assignment-increment.svg)
...
```python
a = 1  # Int (integer) - (whole number)
b = "hello"  # Str (string) - (string)
c = True  # Boolean
d = False  # Boolean
e = [1, 2, 3, 4]  # List - (list)
e = ["a", "b", "c", "d"]  # List
