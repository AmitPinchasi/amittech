...
```
- הסיבה שאנחנו הורדנו את `day_number` באחד, זה בגלל שכאשר אנחנו נגשים לרשימה עם מספרים, המקום תמיד מתחיל ב0, כך שאם אנחנו רוצים לגשת לelement הריבעי אנחנו צריכים לגשת ל `days[3]` לא ל`days[4]` זכור את זה!