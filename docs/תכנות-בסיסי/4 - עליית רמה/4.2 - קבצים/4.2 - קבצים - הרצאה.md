...
![מצביע הקובץ זז לסוף הקובץ אחרי כתיבה עם write, ולכן צריך להחזיר אותו להתחלה עם seek לפני שקוראים עם read](../../../images/illustrations/4-2-file-pointer-seek.svg)
...
![השוואה בין מצב w למצב a: כתיבה במצב w מוחקת את התוכן הקיים של הקובץ, ואילו כתיבה במצב a מוסיפה את התוכן החדש לסוף הקובץ](../../../images/illustrations/4-2-write-vs-append.svg)
