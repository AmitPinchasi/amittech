<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/XENG4Ho2XUw" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
![אורך החיים של משתנה לוקלי: המשתנה נוצר בתוך הפונקציה, נהרס כשהיא מסתיימת, וניסיון לגשת אליו מבחוץ גורם לשגיאת NameError, בעוד שמשתנה גלובלי נגיש בכל התוכנית](../../../images/illustrations/4-3-variable-lifetime.svg)
- **משתנה גלובלי:**
...
![המילה השמורה global מאפשרת לפונקציה לשנות משתנה גלובלי, והשינוי נשאר גם אחרי שהפונקציה מסתיימת - לכן קשה לעקוב אחרי הערך של המשתנה](../../../images/illustrations/4-3-global-keyword.svg)
