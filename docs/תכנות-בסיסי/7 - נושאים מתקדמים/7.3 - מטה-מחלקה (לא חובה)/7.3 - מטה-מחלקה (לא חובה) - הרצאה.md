<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/wdOYLcC9_nY" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
![דיאגרמה: object הוא instance של class, וclass הוא instance של metaclass - היררכיית ה-is instance of בפייתון](../../../images/Pasted image 20240203163801.png)
...
![איור אנימציה: כשיוצרים אובייקט חדש נקראת המתודה __call__ של המטה-קלאס, והיא קוראת ל-__new__ ול-__init__ של הקלאס ומחזירה את האובייקט החדש](../../../images/illustrations/7-3-meta-call.svg)
...
![איור אנימציה: תהליך יצירת קלאס עם מטה-קלאס - המתודה __prepare__ מחזירה מילון ראשוני, הממברים נוספים אליו אחד אחד עם __setitem__, ובסוף המטה-קלאס נקרא ויוצר את הקלאס Dog](../../../images/illustrations/7-3-class-creation.svg)
...
- אז מה הקוד עושה?
	...
	- המתודה `__setitem__` של מילון, מגדירה key וערך חדש במילון ופה אנחנו משתמשים בה כדי להוסיף למילון עוד ממברים של הקלאס שמכילים את השם שלה, המתודות שלה, השדות הסטטים שלה, הטייפ הינטינג של השדות הסטטים שלה, והדוק-סטרינג שלה.
