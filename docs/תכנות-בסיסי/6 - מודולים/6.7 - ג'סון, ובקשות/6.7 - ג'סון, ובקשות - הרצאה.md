...
## הinterfaces של API
- להמון אתרים יש interface API, interface API הוא דרך שבה אפשר לגרום לאתר לעשות/להחזיר כל מיני פעולות.
- הinterfaces של API הן interfaces מיוחדים של האתרים שאנחנו מתממשקים בדיוק כמו שאנחנו נגשים לאתר, לכל נקודת API יש איזשהו קישור כמו https://jsonplaceholder.typicode.com/posts/1, כשאנחנו נגשים לנקודה אנחנו צריכים להעביר לה כל מיני פרמטרים שמציינים איזה פעולה אנחנו רוצים לעשות מול הinterface, וכל מיני פרמטרים.
...
![תרשים זרימה של בקשת GET לנקודת API: הקוד שולח בקשה, השרת מחזיר תשובה בפורמט JSON, והתשובה הופכת למילון פייתון עם המידע](../../../images/illustrations/6-7-api-request-flow.svg)
