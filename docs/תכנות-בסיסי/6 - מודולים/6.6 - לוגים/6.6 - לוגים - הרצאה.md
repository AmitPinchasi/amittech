<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; margin-bottom: 20px;">
  <iframe src="https://www.youtube.com/embed/l2MXTgaasbU" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0;" allowfullscreen></iframe>
</div>
...
![איור מונפש שמראה סינון לוגים לפי רמה: כשהסף מוגדר ל-WARNING, לוג ברמת DEBUG נזרק ולוג ברמת ERROR נכתב לקובץ ולמסך](../../../images/illustrations/6-6-log-level-filter.svg)
