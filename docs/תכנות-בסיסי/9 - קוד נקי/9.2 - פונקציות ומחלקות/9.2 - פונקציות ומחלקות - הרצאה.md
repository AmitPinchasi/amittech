...
![תרשים זרימה שמראה איך process_data מפרקת את העבודה לשלוש פונקציות, כשכל פונקציה עושה דבר אחד בלבד ומעבירה את התוצאה שלה לפונקציה הבאה](../../../images/illustrations/9-2-function-pipeline.svg)
