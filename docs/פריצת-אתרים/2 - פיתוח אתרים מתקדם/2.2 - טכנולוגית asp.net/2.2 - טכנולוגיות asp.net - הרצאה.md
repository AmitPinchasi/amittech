...
![איור מחזור החיים של דף ASP.NET: הדפדפן מבקש קובץ ASPX, השרת מריץ את Page_Load בקוד ה-C# שמעדכן את טקסט הרכיב, ורק ה-HTML הסופי חוזר ללקוח](../../../images/illustrations/web-2-2-aspx-lifecycle.svg)
