...
| אחריות | עיצוב וinterface משתמש     | ניהול מסד נתונים, לוגיקה עסקית, אימות משתמשים |
...
##### קוד Frontend – יצירת interface משתמש עם React
...
![איור מסלול בקשת Fullstack: רכיב React קורא ל-fetch ברקע, שרת Express מטפל בבקשה ומחזיר JSON, ו-setUsers מעדכן את הרכיב כדי להציג את רשימת המשתמשים](../../../images/illustrations/web-2-3-fullstack-fetch.svg)
