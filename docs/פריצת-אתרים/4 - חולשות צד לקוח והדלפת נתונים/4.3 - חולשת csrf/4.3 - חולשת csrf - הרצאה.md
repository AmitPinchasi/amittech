...
![תרשים זרימה של הגנת CSRF Token: בקשה מזויפת מאתר זדוני מגיעה ללא אסימון תואם והשרת דוחה אותה, לעומת בקשה מהטופס האמיתי שמצרפת את האסימון הנכון ומתבצעת בהצלחה](../../../images/illustrations/web-4-3-csrf-token.svg)
