...
![תרשים זרימה המראה כיצד WAF בודק כל בקשת HTTP הנכנסת, ואם מזוהה בה תבנית תקיפה ידועה הוא חוסם אותה, ואילו בקשה תקינה מועברת הלאה לאפליקציה](../../../images/illustrations/web-6-1-waf-request-flow.svg)
