...
![איור זרימת אירוע ב-JavaScript: לחיצה על הכפתור מפעילה מאזין אירועים שמשנה את ה-DOM וההודעה עוברת ממצב מוסתר למוצג](../../../images/illustrations/web-1-4-dom-event.svg)
