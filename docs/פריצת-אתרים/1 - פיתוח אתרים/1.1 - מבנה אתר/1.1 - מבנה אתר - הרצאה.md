...
![איור שלושת מרכיבי האתר: HTML הוא השלד שנותן את המבנה, CSS הוא העור שנותן את העיצוב, ו-JavaScript הוא השרירים שנותנים את ההתנהגות](../../../images/illustrations/web-1-1-three-layers.svg)

איך זה נראה בפועל?
כך יראה אתר רק עם HTML
![צילום מסך: אתר בסיסי עם HTML בלבד - כותרת "ברוכים הבאים לאתר שלי!", טקסט וקישור, ללא עיצוב](../../../images/Pasted image 20250129185550.png)
והנה הקוד של האתר
...
<body>
    ...
    <main>
        <p>This is a simple site based on HTML only.</p>
...
![צילום מסך: אותו אתר עם CSS - כותרת ירוקה מעוצבת, פריסה מסודרת וכותרת תחתונה כהה](../../../images/Pasted image 20250129185803.png)
והנה הקוד
...
<body>
    ...
    <main>
        <p>This is a site with simple styling using CSS.</p>
        <a href="#">Link to somewhere</a>
    </main>
...
![צילום מסך: אותו אתר עם HTML, CSS ו-JavaScript, מציג כפתור "לחץ עליי" אינטראקטיבי](../../../images/Pasted image 20250129185921.png)
האתר מציג כפתור ואחרי לחיצת הכפתור אנחנו נראה את הדבר הבא
![צילום מסך: לאחר לחיצה על הכפתור, מופיעה הודעה ירוקה "ברכת שלום! תודה שלחצת על הכפתור."](../../../images/Pasted image 20250129190013.png)
...
<body>
    ...
    <main>
        <p>This is an interactive site with JavaScript.</p>
        <button onclick="showMessage()">Click me</button>
        <div id="message">Greetings! Thanks for clicking the button.</div>
    </main>
