...
![איור ניתוב לפי Virtual Host: שרת Apache קורא את כותרת ה-Host בבקשה, ולפי הדומיין מפנה את הבקשה לתיקיית האתר הנכונה מבין כמה אתרים על אותו שרת](../../../images/illustrations/web-1-9-vhost-routing.svg)
...
```bash
# Create a file in the new site's folder
sudo mkdir /var/www/mysite
echo "<h1>Welcome to MySite</h1>" | sudo tee /var/www/mysite/index.html

# The command below enables the configuration of the new site we added
sudo a2ensite mysite.conf

# The command below reloads Apache
...
בעצם, אנחנו צריכים לחתום signature דיגיטלית על דומיין מסוים שהוא שלנו, אם תקנו דומיין- תוכלו לחתום על סרטיפיקט HTTPS עליו, כך שאם אנשים יגשו לapache שלכם בhttps לדומיין השחתמתם אילו- תוכלו ליצור תעבורה מוצפנת.
...
3. שלב שלישי, להוסיף את הsignature לאתר שלכם עם apache, כדי שלקוחות מתחברים בפורט 443 עם https לאתר שלכם, שapache ידע להביא להם את הsignature הדיגיטלית שיצרתם, כדי שהדפדפן שלהם יוכל לבדוק מול הauthority שהדומיין הזה באמת שלנו והוא חתום.
### **1. התקנת Certbot**
