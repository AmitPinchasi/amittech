...
תוקף יכול להשתמש ב-XXE כדי לשלוח בקשות לכתובות פנימיות, למשל לנסות לגשת לinterface ניהול בענן.
...
![תרשים המשווה בין פרסר XML שטוען ישות חיצונית מסוג file ומחזיר את תוכן etc passwd בתגובה, לבין פרסר שחוסם ישויות חיצוניות ומונע את דליפת הקובץ](../../../images/illustrations/web-5-7-xxe-disable-entities.svg)
