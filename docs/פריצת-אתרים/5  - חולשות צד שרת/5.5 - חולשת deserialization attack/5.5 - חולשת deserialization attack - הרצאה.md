...
✅ **2. שימוש ב-hash או signatures דיגיטליות**
...
![תרשים המשווה בין unserialize של אובייקט Evil שגורם להפעלת wakeup ולהרצת פקודת מערכת, לבין הגבלת unserialize לרשימת מחלקות מותרות שדוחה את האובייקט הזדוני](../../../images/illustrations/web-5-5-deserialization-wakeup.svg)
