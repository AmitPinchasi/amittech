...
![תרשים המשווה בין קלט file עם ../../../../etc/passwd שמגיע ללא בדיקה ישירות ל-file_get_contents, לבין שימוש ב-realpath שמזהה שהנתיב חורג מתיקיית uploads וחוסם את הגישה](../../../images/illustrations/web-5-3-path-traversal-realpath.svg)
