...
הפרויקטים הבאים משלבים את כל מה שלמדנו בפרק הזה: קומפוננטות, props, סטייט, events, רינדור מותנה, רשימות, טפסים, ו-useEffect. כל פרויקט צריך להיבנות עם טייפסקריפט, בגישת "חשיבה בריאקט" - פירוק לקומפוננטות, סטייט מינימלי, ו-composition.
...
- ניהול שלושה states: loading, error, success
...
- סטייט לניהול state המשחק: start, playing, finished
