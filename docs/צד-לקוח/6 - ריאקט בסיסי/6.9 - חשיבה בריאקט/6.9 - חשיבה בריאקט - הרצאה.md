...
עד עכשיו למדנו את אבני הבניין של ריאקט - קומפוננטות, props, סטייט, events, רשימות, טפסים, ו-useEffect. עכשיו הזמן ללמוד **איך לחשוב בריאקט** - התהליך של בניית אפליקציה מאפס.
