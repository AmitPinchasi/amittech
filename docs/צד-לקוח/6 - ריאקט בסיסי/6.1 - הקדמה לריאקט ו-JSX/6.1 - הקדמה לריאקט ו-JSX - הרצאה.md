...
- ריאקט היא **ספרייה** (library) ולא framework - היא מתמקדת רק ב-UI ולא כוללת routing, ניהול סטייט גלובלי וכו׳
...
<code>&lt;&gt;...&lt;/&gt;</code> הוא קיצור של `<React.Fragment>...</React.Fragment>`. הוא לא מוסיף שום אלמנט ל-DOM - רק מאפשר להחזיר כמה אלמנטים.
...
- פרגמנטים <code>&lt;&gt;...&lt;/&gt;</code> מאפשרים להחזיר כמה אלמנטים בלי עטיפה
