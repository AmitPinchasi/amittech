...
![תרשים המראה את מחזור הרינדור מחדש: לחיצה על הכפתור קוראת ל-setCount, ריאקט מעדכן את הסטייט ומרנדר מחדש את הקומפוננטה, וה-DOM מציג את הערך החדש של המונה](../../../images/illustrations/client-6-4-state-rerender.svg)
