...
3. `children` הוא prop מיוחד שמגיע אוטומטית - התוכן שבין tag הפתיחה לסגירה של הקומפוננטה. Props רגילים מועברים כאטריביוטים על הtag. מבחינת טכנית children הוא פשוט עוד prop, אבל הוא מאפשר תחביר יותר טבעי ו-HTML-י.
