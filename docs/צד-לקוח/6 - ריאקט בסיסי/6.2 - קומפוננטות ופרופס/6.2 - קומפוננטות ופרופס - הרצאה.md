...
כשמשתמשים בקומפוננטה, כותבים אותה כtag JSX. אם אין לה תוכן פנימי, אפשר לסגור אותה עצמאית:
...
![תרשים המראה כיצד קומפוננטת האב App מעבירה את הפרופס לקומפוננטת הבן Greeting בכיוון אחד, וכשהאב משנה את הערך הבן מרנדר מחדש עם הערך החדש](../../../images/illustrations/client-6-2-props-flow.svg)

## ילדים - children

כשעוטפים תוכן בין tag פתיחה לסגירה של קומפוננטה, התוכן מגיע ב-prop מיוחד בשם `children`:
