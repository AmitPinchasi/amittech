...
![תרשים המראה את מסלול הקלט המבוקר: המשתמש מקליד תו, onChange נורה, setState מעדכן את הסטייט, וריאקט מרנדר מחדש כך שערך השדה תמיד מגיע מהסטייט](../../../images/illustrations/client-6-7-controlled-input.svg)
