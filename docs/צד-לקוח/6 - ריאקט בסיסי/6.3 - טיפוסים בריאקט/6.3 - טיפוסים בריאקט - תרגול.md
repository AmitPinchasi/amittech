...
#### תרגיל 2 - טיפוסי events

צרו קומפוננטה `InteractiveBox` שמגיבה לevents שונים:
...
הגדירו פונקציות handler נפרדות לכל event עם הטיפוסים הנכונים. אל תשתמשו ב-`any`.
...
2. למה אנחנו מציינים את סוג האלמנט בטיפוס הevent (למשל `HTMLButtonElement`)?
