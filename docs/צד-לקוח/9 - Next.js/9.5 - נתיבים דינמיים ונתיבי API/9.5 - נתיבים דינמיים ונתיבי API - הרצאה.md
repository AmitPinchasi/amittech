...
![תרשים שמראה שלוש כתובות URL וכיצד כל אחת מהן נתפסת על ידי סוג אחר של תיקייה דינמית והערך שמתקבל בתוך params בכל מקרה](../../../images/illustrations/client-9-5-dynamic-segment-match.svg)
...
![תרשים זרימה שמראה איך generateStaticParams יוצר קובץ HTML סטטי לכל slug בזמן הבנייה ואיך slug חדש שלא נבנה מראש מרונדר בבקשה הראשונה ונשמר](../../../images/illustrations/client-9-5-static-params-build.svg)
...
// define the routes the middleware runs on
export const config = {
