...
export const metadata: Metadata = {
  ...
  robots: {
    index: false, // don't index the privacy page
    follow: false,
  },
};
...
2. **next/image לעומת img רגיל**: next/image מבצע: המרה אוטומטית לפורמטים יעילים (WebP/AVIF), שינוי גודל אוטומטי, lazy loading כברירת מחדל, מניעת Layout Shift, ו-srcset אוטומטי. הtag img רגילה לא עושה שום אופטימיזציה.
