...
![תרשים זרימה שמראה את סדר הרינדור של נתיב בנקסט מהלייאאוט דרך מסך הטעינה ועד לדף עצמו או למסך השגיאה כאשר הרינדור נכשל](../../../images/illustrations/client-9-2-loading-error-boundary.svg)
...
![תרשים שמראה ניווט בין שני דפים בתוך הדשבורד שבו הלייאאוט הראשי והלייאאוט של הדשבורד נשארים על המסך ורק תוכן הדף הפנימי מתחלף](../../../images/illustrations/client-9-2-nested-layout-nav.svg)
...
app/
  (marketing)/
    ...
    pricing/
      page.tsx          →  /pricing
    layout.tsx          # Unique layout for marketing pages
  (app)/
    dashboard/
      page.tsx          →  /dashboard
    settings/
      page.tsx          →  /settings
    layout.tsx          # Unique layout for the application
