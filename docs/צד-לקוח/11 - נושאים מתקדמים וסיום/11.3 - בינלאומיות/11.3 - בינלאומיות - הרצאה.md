...
![תרשים זרימה של בחירת שפה ב-middleware: בודקים אם יש locale בנתיב, אחר כך אם יש עוגיית שפה, אחר כך את השפה שהדפדפן מבקש, ולבסוף מפנים לשפת ברירת המחדל](../../../images/illustrations/client-11-3-locale-routing.svg)
