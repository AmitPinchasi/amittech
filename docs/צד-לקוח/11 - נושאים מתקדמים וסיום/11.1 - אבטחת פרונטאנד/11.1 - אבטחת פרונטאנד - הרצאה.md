...
![תרשים זרימה של התקפת Stored XSS: התוקף שומר תגובה עם סקריפט זדוני בשרת, וכאשר אין סניטציה הסקריפט רץ בדפדפן של הקורבן ושולח את העוגייה לתוקף](../../../images/illustrations/client-11-1-stored-xss-flow.svg)
...
![תרשים זרימה של התקפת CSRF: אתר זדוני שולח טופס נסתר לשרת הבנק בשם המשתמש המחובר, וכאשר העוגייה מוגדרת עם SameSite=Strict היא לא מצורפת והבקשה נדחית](../../../images/illustrations/client-11-1-csrf-samesite.svg)
