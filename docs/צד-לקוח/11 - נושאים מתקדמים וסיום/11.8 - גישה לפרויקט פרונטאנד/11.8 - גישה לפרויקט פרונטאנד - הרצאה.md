...
- הstates קצה - טעינה, שגיאה, רשימה ריקה
...
src/
  ...
  lib/                    # libraries and services
    ...
    auth.ts               # Auth.js definition
    prisma.ts             # Prisma definition
...
```bash
# Recommended structure (Conventional Commits)
...
interface ButtonProps {
  /** Button type - determines the color */
