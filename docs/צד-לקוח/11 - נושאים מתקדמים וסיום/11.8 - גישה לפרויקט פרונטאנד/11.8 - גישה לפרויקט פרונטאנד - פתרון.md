...
A modern task management system for small and medium teams.
Kanban board, real-time collaboration, statistics dashboard.
...
- src/components/ - Components (ui, features, layout)
