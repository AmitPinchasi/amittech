...
![איור של מלכודת פוקוס במודל: המקש Tab מעביר את הפוקוס בין האלמנטים בתוך המודל, ומהאלמנט האחרון הפוקוס חוזר לאלמנט הראשון במקום לצאת לדף שמאחור](../../../images/illustrations/client-11-2-focus-trap.svg)
