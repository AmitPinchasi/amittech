...
![תרשים שמשווה בין העברת props שעוברת דרך כל קומפוננטה בשרשרת לבין קונטקסט שמעביר את הנתונים ישירות לקומפוננטה שצורכת אותם](../../../images/illustrations/client-7-3-prop-drilling-context.svg)
...
![תרשים שמראה איך הפונקציה dispatch שולחת action לפונקציית ה-reducer, שבוחרת את ה-case המתאים ומחזירה אובייקט state חדש שגורם לרינדור מחדש של הקומפוננטה](../../../images/illustrations/client-7-3-reducer-dispatch.svg)
...
// Less good - one giant context
<AppProvider> {/* contains theme, auth, cart */}
  <App />
</AppProvider>
```
