...
function ContactForm() {
  ...
  // Every field change re-renders the entire form!
  // Manual validation - lots of repetitive code
}
```
...
const form = useForm<FormData>({
  ...
  mode: "onBlur", // when to run validation: onChange, onBlur, onSubmit, onTouched, all
});
```
...
// The type is inferred automatically from the schema
