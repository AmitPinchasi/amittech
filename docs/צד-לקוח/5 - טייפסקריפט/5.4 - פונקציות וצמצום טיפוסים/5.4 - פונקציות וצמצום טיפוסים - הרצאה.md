...
![תרשים זרימה המראה כיצד כל בדיקה בפונקציה מצמצמת את הטיפוס של value מטיפוס איחוד רחב עד לטיפוס יחיד ומדויק](../../../images/illustrations/client-5-4-narrowing-walk.svg)
