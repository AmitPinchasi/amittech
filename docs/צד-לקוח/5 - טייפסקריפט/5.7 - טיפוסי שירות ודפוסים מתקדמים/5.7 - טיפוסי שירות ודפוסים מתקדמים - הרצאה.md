...
![תרשים המראה כיצד Omit עובר על שדות הטיפוס המקורי, משמיט את השדות שצוינו ובונה טיפוס חדש שמכיל רק את שאר השדות](../../../images/illustrations/client-5-7-omit-fields.svg)
...
בואו נבנה טיפוס `FormState` שמייצר אוטומטית state לטופס:
