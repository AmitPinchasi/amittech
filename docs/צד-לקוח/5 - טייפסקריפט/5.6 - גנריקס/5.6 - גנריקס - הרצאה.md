...
![תרשים המראה כיצד טייפסקריפט מסיקה את הטיפוס T מהארגומנט של הקריאה וקובעת בהתאם את טיפוס ההחזרה של הפונקציה הגנרית](../../../images/illustrations/client-5-6-generic-binding.svg)
