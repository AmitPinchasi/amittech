...
![תרשים המראה כיצד הקומפיילר tsc בודק טיפוסים ותופס שגיאה עוד לפני שהקוד רץ או ממיר את הקובץ ל-JS ומריץ אותו](../../../images/illustrations/client-5-1-compile-vs-runtime.svg)
