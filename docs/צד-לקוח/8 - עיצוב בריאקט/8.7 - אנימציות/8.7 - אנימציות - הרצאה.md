...
- הן מנחות את תשומת הלב לשינויים בinterface
- מעברים חלקים בין states מרגישים מקצועיים ונעימים
...
## Variants - ניהול states

Variants מאפשרים להגדיר states אנימציה עם שם ולהעביר ביניהם:
...
![מחזור החיים של אלמנט שיוצא מהתצוגה, כאשר AnimatePresence משאירה אותו ב-DOM עד שאנימציית ה-exit מסתיימת ורק אז מסירה אותו](../../../images/illustrations/client-8-7-animate-presence.svg)
...
- LayoutGroup מסנכרן אנימציות layout בין components
...
- כך ניתן לשלב את כל הproperties של Mantine עם אנימציות Framer Motion
...
- initial, animate, exit מגדירים states אנימציה
- transition מגדיר את אופי המעבר (duration, spring, ease)
- Variants מאפשרים ניהול states מורכבים עם שמות
