...
![המסלול של מחלקה בקובץ CSS Module מהכתיבה בקובץ המקור דרך הוספת ה-hash על ידי Vite ועד שם המחלקה הייחודי ב-DOM](../../../images/illustrations/client-8-2-css-modules-build.svg)
...
/* Access a global selector from within a module */
:global(.dark-mode) .sidebar {
  background-color: #2d2d2d;
}

/* Define a global class from within a module */
...
```tsx
// Padding
<div className="p-4">     // padding: 16px (all directions)
...
// Text alignment
<p className="text-right">   // RTL - default in Hebrew
...
// Opacity
<div className="bg-black/50">  // Black background with 50% opacity
<div className="text-white/80"> // White text with 80% opacity
```
...
<div className="grid grid-cols-12">       // 12 columns (like bootstrap)
<div className="grid grid-cols-[1fr_2fr]"> // custom columns

// Element layout
<div className="col-span-2">   // spans 2 columns
<div className="col-span-full"> // spans the whole row
<div className="col-start-2 col-end-4"> // from column 2 to 4
...
// Group hover - when the parent is in hover
