...
הדרך הפשוטה ביותר לעצב קומפוננטה בריאקט היא באמצעות סגנונות אינליין. במקום לכתוב מחרוזת CSS רגילה, בריאקט אנחנו מעבירים אובייקט JavaScript לattribute style.
...
- שימו לב שמות הproperties הם ב-camelCase ולא ב-kebab-case
...
- תמיכה מלאה בכל properties CSS כולל pseudo-classes, media queries, animations
...
- שם הproperties עם $ prefix - כך הם לא מועברים ל-DOM
...
- כל מחלקה מייצגת property CSS אחת
...
![עץ החלטה לבחירת גישת עיצוב בריאקט לפי הצורך בעיצוב מהיר, קיום מעצב עם שפה ייחודית ומורכבות הקומפוננטות](../../../images/illustrations/client-8-1-styling-choice.svg)
