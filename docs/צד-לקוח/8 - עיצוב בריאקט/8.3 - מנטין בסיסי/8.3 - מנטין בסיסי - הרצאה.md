...
function ContainerExample() {
  return (
    <>
      {/* Default container - limited max width */}
      <Container>
...
## System Props - properties מערכת

כל קומפוננטה של Mantine תומכת בproperties מערכת לעיצוב מהיר:
