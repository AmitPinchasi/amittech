...
test('should complete full purchase flow', async ({ page }) => {
  // step 1: search and select the first product
  ...
  // step 3: go back to products and add another product
  ...
  // step 4: go to the cart and check the summary
  ...
  // step 10: check confirmation page
  ...
  for (const [device, viewport] of Object.entries(viewports)) {
    test.describe(`${device} (${viewport.width}x${viewport.height})`, () => {
      ...
      test(`should display product cards correctly on ${device}`, async ({ page }) => {
        ...
        // screenshot of the products area
