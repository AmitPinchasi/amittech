## תרגול - מטא tags ומידע מובנה - Meta Tags and Structured Data

#### תרגיל 1 - מטא-tags מלאות לדף מוצר
...
- הtags Open Graph מלאות (כולל og:type, og:image, og:price:amount)
- הtags Twitter Card
- כתובת canonical
...
כתבו קומפוננטת React שמקבלת אובייקט מוצר ומייצרת tag JSON-LD מלאה עם סכמת Product של Schema.org.
...
יש לכם אתר פודקאסט. צרו קומפוננטה שמייצרת את כל המטא-tags הנדרשות עבור דף פרק בודד.
...
#### תרגיל 6 - ביקורת מטא-tags

כתבו פונקציית בדיקה (utility function) שמקבלת HTML כ-string ומחזירה דוח על מטא-tags:

הפונקציה תבדוק:
- האם יש title ומה האורך שלו
- האם יש meta description ומה האורך שלו
- האם יש tags OG (og:title, og:description, og:image)
...
1. מה ההבדל בין tag `title` לבין `og:title`? האם הם תמיד צריכים להיות זהים?
...
4. מה היתרון של שימוש ב-Metadata API של Next.js לעומת הוספה ידנית של tags meta?
5. מה קורה כשמשתפים קישור בוואטסאפ שלא מכיל tags Open Graph?
