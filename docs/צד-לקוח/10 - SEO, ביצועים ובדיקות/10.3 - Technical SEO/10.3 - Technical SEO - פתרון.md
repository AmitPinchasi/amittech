...
/                                          # homepage
/news                                      # news list
/news/react-19-released                    # a specific news article
/guides                                    # all guides
/guides/react                              # React guides
/guides/react/hooks-complete-guide         # a specific guide
/guides/nodejs                             # Node.js guides
/reviews                                   # product reviews
/reviews/macbook-pro-m4                    # a specific review
/podcast                                   # all episodes
/podcast/ep-42-future-of-web               # a specific episode
/about                                     # about
/contact                                   # contact
```
...
export async function generateSitemaps() {
  // 4 sitemaps: static, categories, products, blog
  return [
    { id: 'static' },
    { id: 'categories' },
    { id: 'products' },
...
.breadcrumbs-list {
  ...
  margin: 0;
  padding: 0;
  /* RTL - the list starts from the right */
  direction: rtl;
}
...
async function main() {
  ...
  console.log('Redirect chain:', report.redirectChains.length);
  console.log('Problematic anchor text:', report.badAnchorTexts.length);
}
```
