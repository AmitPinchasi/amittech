...
- חסר DOCTYPE
- הtag סוגרת לא נכונה
- הtag פותחת בלי סוגרת
- ערך attribute בלי מירכאות
- הtag סגירה לא נכונה
...
4. קישור (הtag a) לאתר גוגל עם attribute href
5. תמונה (הtag img) עם attributes src ו-alt (אפשר לשים כתובת URL של תמונה כלשהי מהאינטרנט)
...
3. ענו:
   ...
   - מצאו את tag ה-head - מה יש בתוכה?
