...
![תרשים אנימציה של בחירת תמונה באלמנט picture: הדפדפן בודק את תנאי הרוחב מלמעלה למטה, ובמסך ברוחב 500 פיקסלים התנאי הראשון נכשל, השני מתקיים ונבחרת התמונה הבינונית](../../../images/illustrations/client-0-5-picture-source-flow.svg)
