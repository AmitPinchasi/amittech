...
- הtag strong מסמנת שהטקסט חשוב מבחינה סמנטית. קוראי מסך ישימו דגש מיוחד עליו.
- הtag b רק משנה את המראה הויזואלי לבולד, בלי להוסיף משמעות.
- עדיף להשתמש בstrong ברוב המקרים כי הוא מוסיף משמעות לתוכן.

**2. מה הattribute alt עושה?**
