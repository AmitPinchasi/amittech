...
<body>
    ...
    <main>
        <article>
            ...
            <p>HTML סמנטי הוא אחד הנושאים החשובים ביותר בפיתוח אתרים מודרני. במקום להשתמש ב-div לכל דבר, אנחנו משתמשים בtags שמתארות את התפקיד של התוכן.</p>
...
- div הוא מכולה גנרית בלי משמעות סמנטית. משתמשים בו רק כשאין tag סמנטית שמתאימה, בעיקר לצורכי עיצוב.
...
- `hidden` (attribute HTML) מסתיר את האלמנט לגמרי - גם מהמסך וגם מקוראי מסך.
