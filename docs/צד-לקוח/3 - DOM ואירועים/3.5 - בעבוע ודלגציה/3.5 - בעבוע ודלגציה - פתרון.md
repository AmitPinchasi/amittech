...
inner
```
כי הbubbling נעצר ולא ממשיך ל-middle ול-outer.
...
- `stopPropagation` עוצר את הbubbling כדי שה-handler של הכרטיס ושל ה-document לא יופעלו
