...
## תרגול bubbling ודלגציה

---

## תרגיל 1 - הבנת bubbling
...
- השתמשו ב-stopPropagation כדי למנוע את הbubbling מהכפתורים
...
דרישות:
- השתמשו בדלגציית events - handler אחד על ה-ul
...
דרישות:
- השתמשו בדלגציית events - handler אחד על ה-tbody לפעולות השורות
...
- כל משימה היא כרטיס עם: כותרת, תיאור קצר, וכפתורי חצים (< >) להזיז לstate הבא/הקודם
