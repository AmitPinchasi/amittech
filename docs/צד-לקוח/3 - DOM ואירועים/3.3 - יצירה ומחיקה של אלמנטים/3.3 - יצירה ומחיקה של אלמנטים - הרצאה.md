...
![תרשים שמראה שאלמנט חדש נוצר בזיכרון בלבד, ורק הקריאה ל-appendChild מציגה אותו בדף](../../../images/illustrations/client-3-3-createelement-append.svg)

## הגדרת תוכן וattributes על אלמנט חדש

אחרי שיצרנו אלמנט, נוסיף לו תוכן וattributes:
