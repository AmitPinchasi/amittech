...
הproperty `opacity` משנה את השקיפות של כל האלמנט (כולל התוכן שלו):
...
- בוחרים פונט
- מקבלים tag link שמוסיפים ל-head
...
![איור המראה כיצד em מוכפל בגודל הפונט של ההורה ומצטבר בקינון ומגיע ל-36px בעוד rem מחושב תמיד מגודל השורש ונשאר 24px](../../../images/illustrations/client-1-3-em-vs-rem.svg)
