...
הגבול הוא המסגרת של הקופסה. הוא מוגדר על ידי שלושה properties: עובי, סגנון וצבע.
...
![איור המשווה בין content-box שבו הריפוד והגבול מתווספים על הרוחב ומגיעים ל-350px לבין border-box שבו הרוחב הכולל נשאר 300px](../../../images/illustrations/client-1-2-box-sizing.svg)
...
![איור המראה שני אלמנטים אנכיים עם שוליים נוגעים שקורסים למרווח של 30px במקום להסתכם ל-50px](../../../images/illustrations/client-1-2-margin-collapse.svg)
