...
- **Block** - component עצמאי: `card`, `button`, `nav`
- **Element** - חלק מ-block, מסומן ב-`__`: `card__title`, `card__image`
- **Modifier** - גרסה שונה, מסומנת ב-`--`: `button--large`, `card--highlighted`

![איור המפרק את שם המחלקה card__button--primary לשלושת חלקיו: בלוק שהוא רכיב עצמאי, אלמנט שהוא חלק בתוך הבלוק המסומן בקו תחתון כפול, ווריאציה המסומנת במקף כפול](../../../images/illustrations/client-1-9-bem-naming.svg)
...
#### היתרונות
- קוד מאורגן יותר - כל מה ששייך לcomponent מקובץ יחד
- פחות חזרה על שמות סלקטורים
- media queries ישירות בתוך הcomponent
