...
![איור המדגים שרשרת סקופ - חיפוש המשתנה b מתחיל בסקופ הפנימי ועולה החוצה עד שהוא נמצא בסקופ של outer](../../../images/illustrations/client-4-1-scope-chain.svg)
...
![איור המדגים ששני מונים שנוצרו מאותו מפעל מחזיקים כל אחד משתנה count עצמאי, ופעולות על מונה אחד לא משפיעות על השני](../../../images/illustrations/client-4-1-closure-counters.svg)
...
התבנית הזו משלבת IIFE עם closures: הפונקציה רצה מיד, יוצרת scope פרטי, ומחזירה אובייקט עם interface ציבורי.
...
![איור המדגים את הבאג הקלאסי של var בלולאה - הלולאה מסיימת ומעלה את i ל-3 לפני שהקולבקים רצים, ולכן כולם מדפיסים 3](../../../images/illustrations/client-4-1-var-loop-bug.svg)
