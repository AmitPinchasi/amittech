...
כשפונקציה משמשת כ-event handler, `this` מצביע על ה-element שקיבל את הevent:
...
![איור המדגים איך אותה פונקציה greet מקבלת this שונה בכל צורת קריאה - כמתודה this הוא alice, כפונקציה מנותקת this הוא undefined, ואחרי bind הוא שוב alice](../../../images/illustrations/client-4-2-this-binding.svg)
...
| event handler (רגיל) | ה-element שקיבל את הevent |
