...
ב-JS, כל אובייקט מחובר לאובייקט אחר שנקרא ה-prototype שלו. כשמנסים לגשת לproperty שלא קיים על אובייקט, JS מחפש אותו ב-prototype, וב-prototype של ה-prototype, וכך הלאה - שרשרת הפרוטוטייפ.
...
![איור המדגים חיפוש property בשרשרת הפרוטוטייפ - החיפוש מתחיל על dog עצמו ואם לא נמצא עולה ל-prototype וכך הלאה עד null](../../../images/illustrations/client-4-3-prototype-chain.svg)
...
מאפשרים להגדיר properties שמתנהגים כמו שדות אבל מריצים קוד:
