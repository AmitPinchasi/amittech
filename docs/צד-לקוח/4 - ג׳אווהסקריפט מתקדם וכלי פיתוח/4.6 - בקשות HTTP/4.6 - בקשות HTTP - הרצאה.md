...
- API (Application Programming Interface) - interface שמאפשר לתוכנות לתקשר ביניהן
...
![איור המדגים ש-fetch לא זורק שגיאה על תשובת 404 אלא מחזיר תשובה, ולכן בודקים את response.ok ומשליכים שגיאה בעצמנו כדי שה-catch יתפוס אותה](../../../images/illustrations/client-4-6-fetch-ok-check.svg)
