...
![איור שמראה את מצב המערך אחרי כל אחת מהפעולות push ו-pop בסוף המערך ו-unshift ו-shift בהתחלה](../../../images/illustrations/client-2-5-array-ends.svg)
...
![איור שמראה את המלכודת של sort: בלי פונקציית השוואה המספרים ממוינים כמחרוזות בסדר שגוי, ועם פונקציית השוואה הם ממוינים נכון](../../../images/illustrations/client-2-5-sort-trap.svg)
