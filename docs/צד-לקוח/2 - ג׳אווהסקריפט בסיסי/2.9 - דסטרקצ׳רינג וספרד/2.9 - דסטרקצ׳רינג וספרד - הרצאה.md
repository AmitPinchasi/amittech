...
![איור של דסטרקצ'רינג מערך שבו כל משתנה מקבל את האיבר במיקום התואם לפי הסדר](../../../images/illustrations/client-2-9-array-destructuring.svg)
...
שימושי מאוד כשרוצים להפריד properties מסוימים מהשאר:
...
![איור שמראה את מלכודת ההעתקה הרדודה: שינוי העיר באובייקט המקונן של ההעתק משנה גם את המקור כי שניהם מצביעים על אותו address](../../../images/illustrations/client-2-9-shallow-copy-trap.svg)
...
- לא עובד עם undefined (מוחק את הproperty)
