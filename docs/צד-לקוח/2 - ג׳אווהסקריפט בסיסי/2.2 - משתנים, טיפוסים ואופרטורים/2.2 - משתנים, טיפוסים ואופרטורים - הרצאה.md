...
![איור שמראה איך הביטוי חמש במחרוזת ועוד שלוש הופך לשרשור מחרוזות ואילו חמש במחרוזת פחות שלוש ממיר למספר ומחשב](../../../images/illustrations/client-2-2-plus-minus-coercion.svg)
...
![איור שמשווה בין השוואה רופפת שממירה את המחרוזת ומחזירה true לבין השוואה מחמירה שבודקת גם את הטיפוס ומחזירה false](../../../images/illustrations/client-2-2-loose-vs-strict.svg)
