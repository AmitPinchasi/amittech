...
![איור של זרימת קריאה לפונקציה add שבו הארגומנטים שלוש וחמש נכנסים לפרמטרים והערך שמונה חוזר דרך return למשתנה](../../../images/illustrations/client-2-4-call-return.svg)
...
![איור שמראה איך createMultiplier מקבלת factor שווה שתיים ומחזירה את הפונקציה double שזוכרת את הערך של factor ומחשבת חמש כפול שתיים](../../../images/illustrations/client-2-4-function-factory.svg)
