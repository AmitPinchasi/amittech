...
![תרשים זרימה של לולאת for שמראה את סדר הריצה של האתחול, בדיקת התנאי, גוף הלולאה והעדכון עם ערכים אמיתיים של i](../../../images/illustrations/client-2-3-for-loop-flow.svg)
...
![תרשים זרימה של לולאת do while שמראה שהגוף רץ פעם אחת ומדפיס מאה לפני שהתנאי נבדק ונכשל](../../../images/illustrations/client-2-3-do-while-flow.svg)
...
![איור של לולאת for of שעוברת על מערך צבעים כשהחץ מצביע על האיבר הנוכחי והמשתנה color מקבל את ערכו בכל סיבוב](../../../images/illustrations/client-2-3-for-of-values.svg)
