...
למה `map` כל כך חשובה? כי ב-React נשתמש בה כל הזמן כדי להפוך מערך של נתונים לרשימת אלמנטים בinterface המשתמש.

![איור של המתודה map שרצה על כל איבר במערך, מכפילה אותו בשתיים ובונה מערך חדש מהתוצאות בלי לשנות את המקור](../../../images/illustrations/client-2-6-map-transform.svg)
...
![איור של המתודה filter שבודקת כל איבר במערך ושומרת רק את המספרים שהתנאי מחזיר עבורם true במערך החדש](../../../images/illustrations/client-2-6-filter-walk.svg)
...
![איור של המתודה reduce שמצטברת בכל צעד: הערך המצטבר acc מתעדכן עם האיבר הנוכחי עד שמגיע לתוצאה הסופית חמש עשרה](../../../images/illustrations/client-2-6-reduce-sum.svg)
