...
![איור המדגים עצירת long scoreboard: הוראת ה-LDG מסמנת את scoreboard מספר 2, וה-IMAD התלוי בה נחסם עד שה-load חוזר מהזיכרון הגלובלי וה-scoreboard מתנקה](../../../images/illustrations/gpu-8-3-scoreboard-stall.svg)
