...
![איור מונפה המראה עמוד בזיכרון מנוהל שנודד בין ה-RAM של ה-host ל-HBM3 של ה-GPU בכל אחד משלבי הגישה](../../../images/illustrations/gpu-3-2-unified-page-migration.svg)
