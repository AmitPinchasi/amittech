...
4. קראו את הפלט: מהי הarithmetic intensity שדווחה? האם ה-kernel מתחת לגג האלכסוני (memory-bound) כפי שציפינו מ-SAXPY?
5. חשבו ביד את הarithmetic intensity התיאורטית של SAXPY (`2N / 12N = 1/6`) והשוו לדיווח של הכלי.
