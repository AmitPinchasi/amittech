...
![איור המתאר את רצף הטיפול ב-page fault של UVM שבו ה-GPU ניגש לדף בזיכרון ה-host, המודול nvidia-uvm.ko משהה את ה-warp, מהגר את הדף אל ה-HBM, מעדכן את טבלאות הדפים וה-warp ממשיך](../../../images/illustrations/gpu-5-2-uvm-page-fault.svg)
