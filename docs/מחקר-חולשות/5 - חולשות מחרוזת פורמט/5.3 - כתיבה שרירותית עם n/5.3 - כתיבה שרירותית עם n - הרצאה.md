...
![אנימציה של כתיבת הערך 0xdeadbeef בשני נתחים של %hn - המונה של printf רק עולה, אז כותבים קודם את הנתח הנמוך 0xbeef ואז מוסיפים את ההפרש עד 0xdead ורק אז כותבים את הנתח הגבוה](../../../images/illustrations/vuln-5-3-hn-chunks.svg)
...
![פריסת ה-payload של כתיבה שרירותית ב-64 ביט - חלק הספציפיירים האסקיי הנקי בתחילה, ריפוד ליישור, ובלוק הכתובות המכיל בתים אפסיים בסוף, כדי שהאפסים לא יקטעו את מחרוזת הformat לפני שהכתיבות בוצעו](../../../images/illustrations/vuln-5-3-payload-layout.svg)
