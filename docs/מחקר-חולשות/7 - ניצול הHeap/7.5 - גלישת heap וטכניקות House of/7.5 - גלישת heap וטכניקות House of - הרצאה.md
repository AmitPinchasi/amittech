...
![תרשים המראה כתיבה שמתחילה בנתוני המשתמש של chunk A וממשיכה כלפי כתובות גבוהות אל תוך המטא-דאטה של השכן הפיזי chunk B, ודורסת קודם את prev_size ואז את size](../../../images/illustrations/vuln-7-5-heap-overflow-neighbor.svg)
