...
- **מנגנון PIE** דלוק וגם **RELRO** במצב Full ו**canary** דלוק. כל אלה מגנים על הבינארי, ואנחנו פשוט לא נתקוף דרכו. זו הסיבה שהתקפות heap כל כך שוות: הן עוקפות את כל שכבת ההגנות של המחסנית מלמעלה.
...
כל ניצול heap מודרני נשען על שני פרימיטיבים שאנחנו בונים מהבאג: **leak** ו**כתיבה**. הנה התוכנית המלאה בשלוש תמונות.
