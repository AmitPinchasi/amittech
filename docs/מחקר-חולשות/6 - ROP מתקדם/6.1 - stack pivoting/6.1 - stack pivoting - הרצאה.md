...
![רעיון הזזת המחסנית - stack pivot: המחסנית האמיתית קטנה מכדי להכיל chain שלמה, אז ה-overflow הקצרה רק מזיזה את rsp אל אזור במה גדול וכתיב שבו כבר מחכה chain מלאה](../../../images/illustrations/vuln-6-1-pivot-concept.svg)
...
![אנימציה של שני leave;ret ברצף בפיבוט - האפילוג של הפונקציה הפגיעה מעביר את rbp לכתובת הבמה, והגאדג'ט השני מזיז את rsp לשם ובולע 8 בתים עם pop rbp, כך שהchain האמיתית מתחילה ב-stage+8](../../../images/illustrations/vuln-6-1-leave-ret-walk.svg)
