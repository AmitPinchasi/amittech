...
![איור המראה כיצד ה-shellcode טוען את הרגיסטרים לפי מוסכמת הsyscall של x86-64, כאשר rdi מצביע על bin//sh ו-rsi ו-rdx אפס ו-rax שווה 59, ואז ההוראה syscall מעבירה ל-kernel שמריץ execve ופותח shell](../../../images/illustrations/vuln-3-1-execve-syscall.svg)
