...
![תרשים זרימה של שיטת patch diffing: לפי זמינות קוד המקור בוחרים בין השוואת קוד מקור להשוואת בינאריים, ושני המסלולים מובילים לאיתור שורת השינוי שהיא שורש הבאג](../../../images/illustrations/vuln-10-4-patch-diffing-workflow.svg)
