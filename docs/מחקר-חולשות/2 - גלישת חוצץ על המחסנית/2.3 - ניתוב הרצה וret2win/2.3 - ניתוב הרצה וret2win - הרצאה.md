...
![איור המראה את המסגרת המזויפת ל-ret2win ב-32 ביט: אחרי הריפוד באים כתובת win, סלוט של return address מזויפת, ורק אחריו הארגומנטים key1 ו-key2, בדיוק כפי ש-win מצפה למצוא על המחסנית](../../../images/illustrations/vuln-2-3-cdecl-fake-frame.svg)
