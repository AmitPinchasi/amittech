...
![איור המראה שבאתגר bof הגלישה ממלאת את overflowme בבתי AAAA, זוחלת דרך saved ebp וכתובת החזרה, ודורסת רק את הארגומנט key בערך 0xcafebabe שהבדיקה מצפה לו](../../../images/illustrations/vuln-2-1-bof-key-overwrite.svg)
...
![איור זרימה המראה שההוראה ret שקולה ל-pop rip, שולפת את הכתובת 0x401156 שדרסנו אל תוך rip, וקופצת אל win שמריצה system של bin sh](../../../images/illustrations/vuln-2-1-ret-rip-redirect.svg)
