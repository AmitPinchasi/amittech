...
![תרשים המראה גישה לא מיושרת החוצה גבול שורת מטמון - קריאה בת שישה עשר בתים מכתובת 0x38 נופלת בין שתי שורות מטמון סמוכות ונוגעת בשתיהן במקום באחת בלבד](../../../images/illustrations/vuln-8-4-cache-line-crossing.svg)
...
![תרשים מבנה נתח glibc בהקצאת malloc במערכת 32 ביט - בסיס הנתח מיושר ל-16 בתים, אבל אחרי שדות prev_size ו-size המצביע שמוחזר למשתמש הוא שמונה מודולו שש עשרה ולא מיושר ל-16](../../../images/illustrations/vuln-8-4-heap-chunk-alignment.svg)
