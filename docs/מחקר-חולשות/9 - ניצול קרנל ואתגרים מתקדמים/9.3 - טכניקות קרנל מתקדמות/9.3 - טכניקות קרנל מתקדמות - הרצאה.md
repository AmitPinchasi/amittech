...
![תרשים של שתי משפחות ההסלמה מכתיבה שרירותית בקרנל: הפקעה מבוססת קוד שעוקפת SMEP ו-SMAP ומריצה commit_creds(prepare_kernel_cred(0)), מול הפקעה מבוססת נתונים בלבד שדורסת modprobe_path בלי להריץ קוד בקרנל כלל - שתיהן מגיעות להרשאות root](../../../images/illustrations/vuln-9-3-privesc-paths.svg)
...
![תרשים זרימה של ניצול use-after-free בקרנל: אובייקט פגיע מוקצה ומשתחרר כשמצביע dangling נשאר, spray מקצה אובייקטים נשלטים באותו גודל, אחד מהם תופס את הזיכרון המשוחרר, והקרנל שקורא מהמצביע הישן בפועל קורא את הנתונים של התוקף](../../../images/illustrations/vuln-9-3-uaf-spray.svg)
