...
![תרשים של גבול ההרשאות בין ring 3 ל-ring 0: תהליך המשתמש חוצה את הגבול באמצעות syscall אל קוד הקרנל המיוחס וחוזר בשלום בסיום, כאשר בתוך הקרנל עצמו אין בידוד נוסף בין המודולים](../../../images/illustrations/vuln-9-1-ring-boundary.svg)
...
![תרשים של צינור הפעולה בשלושה שלבים - leak לחילוץ כתובת, compute לחישוב כתובת היעד מבסיס הקרנל, ו-control לכתיבה לכתובת המחושבת שמסלימה להרשאות root](../../../images/illustrations/vuln-9-1-privesc-pipeline.svg)
