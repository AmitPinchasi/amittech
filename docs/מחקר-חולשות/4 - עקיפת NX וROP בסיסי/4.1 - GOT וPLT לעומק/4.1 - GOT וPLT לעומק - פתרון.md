...
**למה זה חשוב:** דריסת GOT היא רק חצי מהסיפור. החצי השני הוא **מה כותבים** (בדרך כלל `system` או `one_gadget`, שדורש leak) ו**איזו קריאה חוטפים** (כזו עם ארגומנט שאתם שולטים בו). את שני החצאים נחבר יחד בשיעורי 4.4 ו-4.5.
