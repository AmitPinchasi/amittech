...
קורס זה הוא המשך ישיר לקורס מחקר אתרים בסיסי. בעוד הקורס הבסיסי התמקד בהבנת חולשות נפוצות וניצולן הבסיסי, הקורס המתקדם מתמקד בטכניקות מורכבות, chaining חולשות, bypass מנגנוני הגנה, ותקיפות שדורשות הבנה עמוקה של פרוטוקולים ומערכות.
