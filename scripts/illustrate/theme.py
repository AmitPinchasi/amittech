...
def base_css(animated=False):
    css = [
        ...
        ".t{font-family:%s;font-size:15px;font-weight:500;fill:var(--ink);}" % FONT_STACK,
        ".t-b{font-family:%s;font-size:16px;font-weight:700;fill:var(--ink);}" % FONT_STACK,
        ".code{font-family:%s;font-size:13px;fill:var(--ink);direction:ltr;}" % MONO_STACK,
        ".lbl{font-family:%s;font-size:13px;font-weight:600;fill:var(--accent);}" % FONT_STACK,
        ".small{font-family:%s;font-size:12px;fill:var(--muted);}" % FONT_STACK,
